...
sidebar_label: eth_signTypedData_v4
description: Request EIP-712 structured typed data signatures using eth_signTypedData_v4 for human-readable, verifiable signing in MetaMask.
hide_title: true
hide_table_of_contents: true
keywords: [eth_signTypedData_v4, EIP-712, structured data, typed data signing, metamask, ethereum signature, JSON-RPC]
---
