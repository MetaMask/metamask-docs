...
<SimplifiedApiReference
  ...
  parameters={[{
    ...
    children: [
      { name: "chainId", type: "string", required: true, description: "The chain ID as a `0x`-prefixed hexadecimal string, as returned by the `eth_chainId` method." }
    ]
  }]}
  returns={{
  type: "null",
  ...
  errors={[{ code: 4902, message: "Unrecognized chain ID. Try adding the chain using wallet_addEthereumChain first.", description: "Unrecognized chain ID. Try adding the chain using wallet_addEthereumChain first." }]}
