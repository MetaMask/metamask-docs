...
sidebar_label: wallet_sendCalls
description: Submit a batch of calls using wallet_sendCalls (EIP-5792) for atomic or sequential multi-transaction execution in MetaMask.
hide_title: true
hide_table_of_contents: true
keywords: [wallet_sendCalls, EIP-5792, batch calls, atomic transactions, metamask, JSON-RPC, smart contract calls]
---
