...
- Documented that the Gas API can be [called without an API key secret](/services/gas-api/quickstart). ([#1346](https://github.com/MetaMask/metamask-docs/pull/1346))
