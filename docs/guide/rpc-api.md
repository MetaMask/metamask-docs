...
With the exception of [MetaMask Flask](./snaps.html#availability), the only existing permission is `eth_accounts`, which allows you to access the user's Ethereum address(es).
