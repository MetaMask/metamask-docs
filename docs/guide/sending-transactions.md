...
MetaMask helps users select a competitive gas price on the Ethereum Main Network and popular test networks. Users can easily choose between "slow," "medium," and "fast" options for their gas price, or [get specific if they want](https://metamask.zendesk.com/hc/en-us/articles/360022895972).
