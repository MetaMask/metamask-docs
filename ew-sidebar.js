...
const sidebar = {
  ...
  sdk_react: [
    ...
    'sdk/react/examples',
    {
      ...
      items: [{ type: 'autogenerated', dirName: 'sdk/react/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_vue: [
    ...
    'sdk/vue/examples',
    {
      type: 'category',
      label: 'Migration guides',
      items: [{ type: 'autogenerated', dirName: 'sdk/vue/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_js: [
    ...
    'sdk/js/events',
    {
      ...
      items: [
        ...
        'sdk/js/usage/get-identity-token',
        'sdk/js/usage/logout',
      ...
      items: [
        {
          type: 'category',
          label: 'Modal',
          items: [{ type: 'autogenerated', dirName: 'sdk/js/migration-guides/modal' }],
        },
        {
          type: 'category',
          label: 'No modal',
          items: [{ type: 'autogenerated', dirName: 'sdk/js/migration-guides/no-modal' }],
        },
      ],
    },
    {
  ...
  sdk_android: [
    ...
    'sdk/android/examples',
    {
      type: 'category',
      label: 'Migration guides',
      items: [{ type: 'autogenerated', dirName: 'sdk/android/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_ios: [
    ...
    'sdk/ios/examples',
    {
      type: 'category',
      label: 'Migration guides',
      items: [{ type: 'autogenerated', dirName: 'sdk/ios/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_react_native: [
    ...
    'sdk/react-native/examples',
    {
      type: 'category',
      label: 'Migration guides',
      items: [{ type: 'autogenerated', dirName: 'sdk/react-native/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_flutter: [
    ...
    'sdk/flutter/examples',
    {
      type: 'category',
      label: 'Migration guides',
      items: [{ type: 'autogenerated', dirName: 'sdk/flutter/migration-guides' }],
    },
    {
      type: 'link',
      label: 'Troubleshooting',
