...
const sidebar = {
  overview: [
    ...
    },
    {
      ...
      items: [{ type: 'autogenerated', dirName: 'migration-guides' }],
    },
    {
      type: 'category',
  ...
  authentication: [
    ...
    },
    {
      ...
      items: [
        ...
        'authentication/social-logins/apple',
        'authentication/social-logins/facebook',
        'authentication/social-logins/x',
        'authentication/social-logins/discord',
        'authentication/social-logins/twitch',
        'authentication/social-logins/github',
        'authentication/social-logins/reddit',
        'authentication/social-logins/line',
        'authentication/social-logins/kakao',
        'authentication/social-logins/linkedin',
        'authentication/social-logins/wechat',
        'authentication/social-logins/telegram',
        'authentication/social-logins/farcaster',
      ],
    },
    {
      type: 'category',
  ...
  evm: [
    ...
    },
    {
      type: 'category',
      label: 'Ethereum',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/ethereum' }],
    },
    {
      type: 'category',
      label: 'Linea',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/linea' }],
    },
    ...
    },
    {
      type: 'category',
      label: 'Avalanche',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/avalanche' }],
    },
    {
      type: 'category',
      label: 'Base',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/base' }],
    },
    {
      type: 'category',
      label: 'BNB Chain',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/bnb' }],
    },
    {
      type: 'category',
      label: 'Monad',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/monad' }],
    },
    {
      type: 'category',
      label: 'Optimism',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/optimism' }],
    },
    {
      type: 'category',
      label: 'Polygon',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/polygon' }],
    },
    {
      type: 'html',
      value:
        "<strong style='font-size:1.1em;display:block;margin:12px 0;'>EVM Compatible Chains</strong>",
      defaultStyle: true,
    },
    {
      type: 'category',
      label: 'Aleph Zero',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/aleph-zero' }],
    },
    {
      type: 'category',
      label: 'Ancient8',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/ancient8' }],
    },
    {
      type: 'category',
      label: 'Astar zKyoto',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/astar-zkyoto' }],
    },
    {
      type: 'category',
      label: 'Astar zkEVM',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/astar-zkevm' }],
    },
    {
      type: 'category',
      label: 'BitKub',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/bitkub' }],
    },
    {
      type: 'category',
      label: 'Celo',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/celo' }],
    },
    {
      type: 'category',
      label: 'Chiliz',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/chiliz' }],
    },
    {
      type: 'category',
      label: 'Cronos',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/cronos' }],
    },
    {
      type: 'category',
      label: 'Fhenix',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/fhenix' }],
    },
    {
      type: 'category',
      label: 'Flare',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/flare' }],
    },
    {
      type: 'category',
      label: 'Flow',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/flow' }],
    },
    {
      type: 'category',
      label: 'Harmony',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/harmony' }],
    },
    {
      type: 'category',
      label: 'Hedera',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/hedera' }],
    },
    {
      type: 'category',
      label: 'Kinto',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/kinto' }],
    },
    {
      type: 'category',
      label: 'Klaytn',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/klaytn' }],
    },
    {
      type: 'category',
      label: 'Manta',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/manta' }],
    },
    {
      type: 'category',
      label: 'Metis',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/metis' }],
    },
    {
      type: 'category',
      label: 'Mint',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/mint' }],
    },
    {
      type: 'category',
      label: 'Moonbeam',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/moonbeam' }],
    },
    {
      type: 'category',
      label: 'Moonriver',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/moonriver' }],
    },
    {
      type: 'category',
      label: 'Morph',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/morph' }],
    },
    {
      type: 'category',
      label: 'Neon',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/neon' }],
    },
    {
      type: 'category',
      label: 'Nibiru',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/nibiru' }],
    },
    {
      type: 'category',
      label: 'opBNB',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/opbnb' }],
    },
    {
      type: 'category',
      label: 'Rootstock',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/rootstock' }],
    },
    {
      type: 'category',
      label: 'Saakuru',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/saakuru' }],
    },
    {
      type: 'category',
      label: 'Shardeum',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/shardeum' }],
    },
    {
      type: 'category',
      label: 'SKALE',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/skale' }],
    },
    {
      type: 'category',
      label: 'Songbird',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/songbird' }],
    },
    {
      type: 'category',
      label: 'Soneium',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/soneium' }],
    },
    {
      type: 'category',
      label: 'Unichain',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/unichain' }],
    },
    {
      type: 'category',
      label: 'XDC Network',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/xdc' }],
    },
    {
      type: 'category',
      label: 'Zetachain',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/zetachain' }],
    },
    {
      type: 'category',
      label: 'Zilliqa',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/zilliqa' }],
    },
    {
      type: 'category',
      label: 'Zircuit',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/zircuit' }],
    },
    {
      type: 'category',
      label: 'Tron',
      items: [{ type: 'autogenerated', dirName: 'connect-blockchain/evm/tron' }],
    },
    'connect-blockchain/evm/rpc-headers',
  ],
  solana: [{ type: 'autogenerated', dirName: 'connect-blockchain/solana' }],
  sdk_react: [
    {
      type: 'html',
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/react/hooks/useAuthTokenInfo',
    ...
    'sdk/react/examples',
    {
      ...
      href: '/embedded-wallets/migration-guides/web/',
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_vue: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/vue/composables/useAuthTokenInfo',
  ...
  sdk_js: [
    ...
    'sdk/js/events',
    {
      ...
      items: [
        ...
        'sdk/js/usage/get-user-info',
        'sdk/js/usage/get-auth-token-info',
        'sdk/js/usage/logout',
        'sdk/js/usage/enable-mfa',
        'sdk/js/usage/manage-mfa',
        'sdk/js/usage/show-checkout',
        'sdk/js/usage/show-swap',
        'sdk/js/usage/switch-chain',
        'sdk/js/usage/show-wallet-connect-scanner',
        'sdk/js/usage/show-wallet-ui',
      ],
    },
  ...
  sdk_android: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/android/usage/enable-mfa',
        'sdk/android/usage/manage-mfa',
        'sdk/android/usage/launch-wallet-services',
    ...
    'sdk/android/examples',
    {
      type: 'link',
      label: 'Migration Guide',
      href: '/embedded-wallets/migration-guides/android/',
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_ios: [
    ...
    'sdk/ios/examples',
    {
      type: 'link',
      label: 'Migration Guide',
      href: '/embedded-wallets/migration-guides/ios/',
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_react_native: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/react-native/usage/user-info',
        'sdk/react-native/usage/private-key',
        'sdk/react-native/usage/ed25519-key',
        'sdk/react-native/usage/logout',
        'sdk/react-native/usage/enable-mfa',
        'sdk/react-native/usage/launch-wallet-services',
    ...
    'sdk/react-native/examples',
    {
      type: 'link',
      label: 'Migration Guide',
      href: '/embedded-wallets/migration-guides/react-native/',
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_flutter: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/flutter/usage/connect-to',
        'sdk/flutter/usage/get-user-info',
        'sdk/flutter/usage/get-private-key',
        'sdk/flutter/usage/get-ed25519-private-key',
        'sdk/flutter/usage/logout',
        'sdk/flutter/usage/enable-mfa',
        'sdk/flutter/usage/manage-mfa',
        'sdk/flutter/usage/show-wallet-ui',
    ...
    'sdk/flutter/examples',
    {
      type: 'link',
      label: 'Migration Guide',
      href: '/embedded-wallets/migration-guides/flutter/',
    },
    {
      type: 'link',
      label: 'Troubleshooting',
  ...
  sdk_unity: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/unity/usage/get-user-info',
        'sdk/unity/usage/get-private-key',
  ...
  sdk_unreal: [
    ...
    },
    {
      ...
      items: [
        ...
        'sdk/unreal/usage/get-user-info',
        'sdk/unreal/usage/get-private-key',
        'sdk/unreal/usage/get-ed25519-private-key',
