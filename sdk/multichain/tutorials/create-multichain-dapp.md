...
This tutorial uses [scopes, account IDs, and sessions](../concepts/scopes.md) to identify chains
and accounts across ecosystems. If you're unfamiliar with these concepts, review them before
continuing.
