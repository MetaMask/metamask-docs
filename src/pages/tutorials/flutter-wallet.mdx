...
description: "Empower your Flutter app with a chain-agnostic web3 wallet using the MetaMask Embedded Wallets SDK."
...
Sign up on the [Embedded Wallets dashboard](https://dashboard.web3auth.io/). It's free 
