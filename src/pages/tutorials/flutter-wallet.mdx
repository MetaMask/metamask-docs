...
description: Empower your Flutter app with a chain-agnostic web3 wallet using the Embedded Wallets SDK.
...
In this guide, we'll talk about how we can use Embedded Wallets (formerly Web3Auth) to build your chain-agnostic Web3 wallet in Flutter. The wallet will support the Ethereum and Solana ecosystem.

You will create a demo app which supports user log in, display user details, and performs blockchain interactions. The signing of the blockchain transactions is done through the Embedded Wallets SDK. 
...
After successfully installing the package, the next step is to initialize Web3Auth in your Flutter app. This sets up the necessary configurations using Client Id and prepares Web3Auth. [Learn more about Web3Auth Initialization](/embedded-wallets/sdk/flutter#initialize-web3auth).
...
Learn more about [Web3Auth LoginParams](/embedded-wallets/sdk/flutter/usage/login#parameters).
...
If you want to learn, how you can integrate different blockchain with Web3Auth, you can checkout our [Connect Blockchain resources](/embedded-wallets/connect-blockchain/).
...
If you are interested in learning more about Web3Auth, please checkout our [documentation for Flutter](/embedded-wallets/sdk/flutter). You can find the code used for the guide on our [examples repo](https://github.com/Web3Auth/web3auth-flutter-examples/tree/main/flutter-playground).
