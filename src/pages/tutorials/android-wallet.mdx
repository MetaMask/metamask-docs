...
description: "Empower your Android app with an Ethereum web3 wallet using the MetaMask Embedded Wallets "
...
<SEO
  ...
  description="Empower your Android app with an Ethereum Web3 wallet using the Embedded Wallets (Web3Auth PnP SDK)."
  image="https://docs.metamask.io/img/tutorials/tutorials-banners/android-wallet.png"
  slug="/tutorials/android-wallet"
/>

In this guide, we'll use the MetaMask Embedded Wallets SDK (formerly Web3Auth Plug and Play) 
...
You will create a demo app which supports user login, displays user details, and performs blockchain 
interactions. The signing of the blockchain transactions is done through the Embedded Wallets SDK. 
...
Learn more about [Embedded Wallets' `LoginParams`](/embedded-wallets/sdk/android/usage/login#parameters).
