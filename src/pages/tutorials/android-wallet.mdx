...
For the prerequisites, and other mandatory configuration of the SDK, please head to our [installation documentation](/embedded-wallets/sdk/android/install).

### Initialization

After successfully installing the package, the next step is to initialize Web3Auth in your Android app. This sets up the necessary configurations using Client Id and prepares Web3Auth. [Learn more about Web3Auth Initialization](/embedded-wallets/sdk/android/initialize).
...
Learn more about [Web3Auth LoginParams](/embedded-wallets/sdk/android/usage#parameters).
