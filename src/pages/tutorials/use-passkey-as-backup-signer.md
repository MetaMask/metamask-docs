...
tags: [delegation, smart accounts kit, passkey, backup signer, smart account]
...
Install the [MetaMask Smart Accounts Kit](https://www.npmjs.com/package/@metamask/smart-accounts-kit) and [Ox SDK](https://oxlib.sh/#installation) in your project:
