...
description: Build gasless transactions with a paymaster using Embedded Wallets Native Account Abstraction (ERC-4337). Sponsor user gas fees in your dapp.
...
1.1 If you haven't already, sign up on the [Embedded Wallets platform](https://developer.metamask.io). Access to the
...
EOA (Externally Owned Account) signer; no additional setup is needed.
...
<Tabs
  ...
  values={[
    { label: "Viem", value: "viem" },
    { label: "Ethers", value: "ethers" },
    { label: "Wagmi", value: "wagmi-tab" },
  ]}
>

<TabItem value="wagmi-tab">
