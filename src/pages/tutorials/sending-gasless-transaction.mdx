...
image: 'img/guides/guides-img/embedded-wallets/banners/gasless-transaction.png'
...
<SEO
  title="Send your first gasless transaction"
  description="Learn how to use gasless paymaster with Web3Auth Native Account Abstraction."
  image="https://docs.metamask.io/img/guides/guides-img/embedded-wallets/banners/gasless-transaction.png"
