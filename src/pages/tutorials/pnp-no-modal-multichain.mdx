...
- For Mobile Apps: For the Web3Auth Mobile SDKs, you have a choice between iOS, Android, React Native, and Flutter.
  Refer to the [Web3Auth SDK Reference](/embedded-wallets/sdk/) for more information.

## Step 1: Set up Embedded Wallets dashboard

Create a Web3Auth account on the [MetaMask Developer Dashboard](https://developer.metamask.io). The basic account is free.
...
// Get your client ID from https://developer.metamask.io
...
Set up the main app component with:
