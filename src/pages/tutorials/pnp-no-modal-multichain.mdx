...
image: 'img/guides/guides-img/embedded-wallets/banners/multi.png'
...
<SEO
  title="Create a Chain Agnostic Web3 Wallet with Web3Auth"
  description="Learn how to create a chain-agnostic Web3 wallet using Web3Auth"
  image="https://docs.metamask.io/img/guides/guides-img/embedded-wallets/banners/multi.png"
...
- [Web3Auth Documentation](https://docs.metamask.io/)
