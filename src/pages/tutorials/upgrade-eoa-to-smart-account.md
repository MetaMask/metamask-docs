...
This tutorial walks you through upgrading a MetaMask externally owned account (EOA) to a [MetaMask smart account](/smart-accounts-kit/concepts/smart-accounts) via [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702), and sending an [atomic batch transaction](/metamask-connect/evm/guides/send-transactions/batch-transactions) via [EIP-5792](https://eips.ethereum.org/EIPS/eip-5792).
...
- [MetaMask](https://metamask.io/) installed, with an EOA that has Sepolia ETH
  :::note
  You can use the [Infura faucet](https://www.infura.io/faucet) to get Sepolia ETH.
  :::
...
In `src/app/page.tsx`, use the [`useSendCalls`](https://wagmi.sh/react/api/hooks/useSendCalls) hook from Wagmi to handle and send [atomic batch transactions](/metamask-connect/evm/guides/send-transactions/batch-transactions).
