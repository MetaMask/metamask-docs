      ...
      return (
        <div className={className}>
          ...
          {isLimitedUserPlan && (
            <Accordion>
              ...
              <Text as="p" className={styles.accordionContainer}>
                MetaMask requires an address with Ethereum Mainnet activity to
                ...
                number of transactions can earn you up to 0.5. MetaMask maintains
          ...
          <Accordion>
            ...
            <Text as="p" className={styles.accordionContainer}>
              A faucet is a platform that gives you testnet tokens to use when
              testing your smart contracts. This faucet gives
              you Sepolia ETH to test deploying smart contracts and sending
              transactions before deploying your dapp on Mainnet.
            </Text>
          </Accordion>
          <Accordion>
            <Text as="h3" className={styles.accordionHeader}>
            ...
            <Text as="p" className={styles.accordionContainer}>
              <span>
                ...
                enables the experience and security guarantees of Ethereum, but with
                lower transaction costs and greater speed.
              </span>
            </Text>
          </Accordion>
          <Accordion>
          ...
          <Accordion>
            ...
            <Text as="p" className={styles.accordionContainer}>
              <span>
                If you have ideas on how to improve the faucet,
                feel free to submit them on{" "}
                <a
      ...
      return (
        <div className={className}>
          ...
          <Accordion>
            ...
            <Text as="p" className={styles.accordionContainer}>
              The Sepolia ETH comes from MetaMask's partnership with the Ethereum
              Foundation. We maintain an always-on, reliable faucet
              environment to support the development community.
            </Text>
          </Accordion>
        </div>
      );
