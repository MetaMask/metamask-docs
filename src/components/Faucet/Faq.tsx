    ...
    case "linea":
      return (
        <div className={className}>
          ...
          <Accordion>
            <AccordionHeader>What is Infura?</AccordionHeader>
            <AccordionBody>
              Infura is the world’s most powerful suite of high availability
              blockchain APIs and developer tools. Infura brings together
              everything you need to start building on Web3, with infinitely
              scalable systems and exceptional documentation.
            </AccordionBody>
          </Accordion>
          <Accordion>
            <AccordionHeader>What is Linea?</AccordionHeader>
            <AccordionBody>
              ...
              developers to build on it as they would on Ethereum mainnet. Linea
              allows you to deploy any smart contract, use any tool, and develop
              as if you’re building on Ethereum. For users, this enables
              experience and security guarantees of Ethereum, but with lower
              transaction costs and at greater speed.
            </AccordionBody>
          </Accordion>
          <Accordion>
            <AccordionHeader>
          ...
          <Accordion>
            <AccordionHeader>Where does Linea ETH come from?</AccordionHeader>
            <AccordionBody>
    ...
    case "sepolia":
      return (
        <div className={className}>
          ...
          <Accordion>
            <AccordionHeader>Where does Sepolia ETH come from?</AccordionHeader>
            <AccordionBody>
