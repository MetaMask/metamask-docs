  ...
  return (
    <div className={className}>
      <div className={classNameHeading}>
        ...
        <Text as="p">
          Here is a list of your requests from the MetaMask faucet. View your transaction on
          Etherscan for more information.
        </Text>
      </div>
      <Table thCells={['Your Transactions', 'Age', 'Value', 'Status', '']} trRows={dataRows} />
    </div>
  )
}
