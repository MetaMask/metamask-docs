...
import { web, mobile, gaming, backend } from './SDKOptions'
import { webIcons, mobileIcons, gamingIcons, backendIcons } from './icons'
      ...
      <div className={styles.cardContent}>
        <div className={styles.sdkIconContainer}>
          <svg
            ...
            className={styles.sdkIcon}>
            <path
              d="M320 104.5c171.4 0 303.2 72.2 303.2 151.5S491.3 407.5 320 407.5c-171.4 0-303.2-72.2-303.2-151.5S148.7 104.5 320 104.5m0-16.8C143.3 87.7 0 163 0 256s143.3 168.3 320 168.3S640 349 640 256 496.7 87.7 320 87.7zM218.2 242.5c-7.9 40.5-35.8 36.3-70.1 36.3l13.7-70.6c38 0 63.8-4.1 56.4 34.3zM97.4 350.3h36.7l8.7-44.8c41.1 0 66.6 3 90.2-19.1 26.1-24 32.9-66.15 14.3-88.1-9.7-11.2-25.3-16.7-46.5-16.7h-70.7L97.4 350.3zm185.7-213.6h36.5l-8.7 44.8c31.5 0 60.7-2.3 74.8 10.7 14.8 13.6 7.7 31-8.3 113.1h-37c15.4-79.4 18.3-86 12.7-91-5.1-4.5-13.6-4.1-33.6-4.1l-13.7 70.6h-36.6l8.7-44.8c-31.1 0-60.51 2.3-74.8-10.7-14.8-13.6-7.7-31 8.3-113.1h36.5c-15.4 79.4-18.3 86-12.7 91 5.1 4.5 13.6 4.1 33.6 4.1l13.7-70.6zm94.2 0h36.7c-19.3 99.2-21.3 101.9-14.3 88.1 9.7-11.2 25.3-16.7 46.5-16.7h70.7l-32.1 165.1h-36.7l8.7-44.8c-41.1 0-66.6-3-90.2 19.1-26.1 24-32.9 66.15-14.3 88.1zm185.7 213.6h36.7l-8.7-44.8c41.1 0 66.6 3 90.2-19.1 26.1-24 32.9-66.15 14.3-88.1-9.7-11.2-25.3-16.7-46.5-16.7h-70.7l-32.1 165.1zm97.2-213.6h36.5l-8.7 44.8c31.5 0 60.7-2.3 74.8 10.7 14.8 13.6 7.7 31-8.3 113.1h-37c15.4-79.4 18.3-86 12.7-91-5.1-4.5-13.6-4.1-33.6-4.1l-13.7 70.6h-36.6l8.7-44.8c-31.1 0-60.51 2.3-74.8-10.7-14.8-13.6-7.7-31 8.3-113.1h36.5c-15.4 79.4-18.3 86-12.7 91 5.1 4.5 13.6 4.1 33.6 4.1l13.7-70.6z"
              fill="currentColor"
            />
          </svg>
        </div>
        <div className={styles.cardContentText}>
          <h3>Node.js SDK</h3>
          <div className={styles.links}>
            <a href={`embedded-wallets/sdk/node`}>SDK Reference{chevron}</a>
            <a href={`embedded-wallets/sdk/node/examples`}>Examples{chevron}</a>
          </div>
        </div>
      </div>
    </ul>
...
export const pnpbackend = (
  <div className={styles.card}>
    <div className={styles.cardContainerIntro}>
      <div className={styles.cardTitleContainer}>
        <h3>Embedded Wallets Backend SDKs</h3>
        {/* <div className={styles.pillContainer}>
          <div className={styles.pill}>{pnp} Only</div>
        </div> */}
      </div>
      ...
      <p>
        Integrate MetaMask Embedded Wallets (Web3Auth) with just 4 lines of code. <br />
        <br />
        Seamlessly authenticate users into your Web3 apps with their socials using Web3Auth Backend
        SDKs.
      </p>
      {backendIcons}
    </div>
    <ul className={styles.cardContainer}>
      <div className={styles.cardContent}>
        <div className={styles.sdkIconContainer}>
          <svg width="24" height="24" viewBox="-16.5 0 289 289" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"
            className={styles.sdkIcon}>
    ...
    <div className={styles.container}>
      <div className={styles.headingContainer}>
        <div className={styles.tabContainer}>
          ...
          <div
            className={platform === backend ? styles.selectedTab : styles.tab}
