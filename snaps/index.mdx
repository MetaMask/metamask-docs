...
<SEO
  title="MetaMask Snaps - Browser Extension Development"
  description="Create mini apps for MetaMask browser extension. Extend MetaMask with custom functionalities and new blockchain protocols using Snaps API."
  keywords={[
    'metamask snaps',
    'browser extension',
    'metamask flask',
