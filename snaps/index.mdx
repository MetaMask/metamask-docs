...
<SEO
  ...
  description="Create custom mini apps that run inside MetaMask extension. Open source system for extending MetaMask with new web3 functionalities and blockchain protocols."
  keywords={[
    'metamask snaps',
    'mini apps',
    'browser extension',
