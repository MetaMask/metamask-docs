...
You can further explore Snaps by engaging with [tutorials](/learn/tutorials/index.md), [how-to guides](/how-to/index.md), and other [resources](/learn/resources.md).
...
<CardList
  items={[
    ...
    },
    {
      ...
      description: "Learn and explore MetaMask Snaps with supplemental resources, tools, examples, and guides.",
    }
  ]}
/>
