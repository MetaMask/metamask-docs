...
If your Snap uses [`snap_dialog`](snaps-api/snap_dialog) to show user interfaces, you can use the
...
- `toRender(expectedInterface)` - Checks if a Snap rendered an interface.
  This is useful for testing the user interface of a Snap, either for a [`snap_dialog`](snaps-api/snap_dialog)
