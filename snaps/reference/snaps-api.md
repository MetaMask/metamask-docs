...
Snaps can communicate with and modify the functionality of MetaMask using the Snaps API.
To call each method, a Snap must first request permission in [snap manifest file](../how-to/request-permissions.md).
