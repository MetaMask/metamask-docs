...
call some [MetaMask JSON-RPC API](/sdk/evm/reference/json-rpc-api) methods.
...
A Snap can request permission to call the [`eth_accounts`](/sdk/evm/reference/json-rpc-api) MetaMask
JSON-RPC API method by calling [`eth_requestAccounts`](/sdk/evm/reference/json-rpc-api).
...
[`wallet_getPermissions`](/sdk/evm/reference/json-rpc-api).
