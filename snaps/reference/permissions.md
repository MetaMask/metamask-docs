...
call some [MetaMask JSON-RPC API](/metamask-connect/evm/connect/reference/json-rpc-api) methods.
...
A Snap can request permission to call the [`eth_accounts`](/metamask-connect/evm/connect/reference/json-rpc-api) MetaMask
JSON-RPC API method by calling [`eth_requestAccounts`](/metamask-connect/evm/connect/reference/json-rpc-api).
...
[`wallet_getPermissions`](/metamask-connect/evm/connect/reference/json-rpc-api).
