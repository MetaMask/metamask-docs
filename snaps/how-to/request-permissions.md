...
Request permission to call [Snaps API methods](../reference/snaps-api) in the
`initialPermissions` field of the Snap [manifest file](../learn/about-snaps/files.md#manifest-file).
For example, to request to call [`snap_dialog`](../reference/snaps-api/snap_dialog), add the
...
- [`snap_createInterface`](../reference/snaps-api/snap_createinterface)
- [`snap_getInterfaceState`](../reference/snaps-api/snap_getinterfacestate)
- [`snap_updateInterface`](../reference/snaps-api/snap_updateinterface)
