...
[`snap_createInterface`](../../reference/snaps-api/snap_createinterface) method.
This method returns the ID of the created interface.
You can pass this ID to [`snap_dialog`](../../reference/snaps-api/snap_dialog), returned from
...
[`snap_updateInterface`](../../reference/snaps-api/snap_updateinterface) method.
...
To retrieve its state, call the [`snap_getInterfaceState`](../../reference/snaps-api/snap_getinterfacestate)
method with the interface ID.
To retrieve its context, call [`snap_getInterfaceContext`](../../reference/snaps-api/snap_getinterfacecontext)
