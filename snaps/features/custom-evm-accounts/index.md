...
The Snap keeps track of the accounts that it creates using [`snap_manageState`](../../reference/snaps-api/snap_managestate).
...
state using [`snap_manageState`](../../reference/snaps-api/snap_managestate).
...
and the Snap resolves the request using [`snap_manageAccounts`](../../reference/snaps-api/snap_manageaccounts),
