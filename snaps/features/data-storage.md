...
Use the [`snap_manageState`](../reference/snaps-api/snap_managestate.mdx) API method to persist up to
...
[`snap_manageState`](../reference/snaps-api/snap_managestate.mdx) permission.
...
By default, [`snap_manageState`](../reference/snaps-api/snap_managestate.mdx) automatically encrypts
...
using [`snap_manageState`](../reference/snaps-api/snap_managestate.mdx).
...
package for a full example of storing data using [`snap_manageState`](../reference/snaps-api/snap_managestate.mdx).
