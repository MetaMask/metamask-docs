...
The following table displays the <GlossaryTerm term="Advanced Permissions" /> types supported by the 
<GlossaryTerm term="Smart Accounts Kit" />, [MetaMask Flask](/snaps/get-started/install-flask), and MetaMask production, and the minimum version required for each.
