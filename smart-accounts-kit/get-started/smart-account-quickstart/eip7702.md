...
This quickstart demonstrates how to upgrade your <GlossaryTerm term="EOA" /> to support <GlossaryTerm term="MetaMask smart account" />
...
Set up <GlossaryTerm term="Wallet Client" /> using Viem's [`createWalletClient`](https://viem.sh/docs/clients/wallet) function. 
...
Create an authorization to map the contract code to an <GlossaryTerm term="EOA" />, and sign it 
