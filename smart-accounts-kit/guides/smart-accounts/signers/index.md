...
generating the signatures required to submit user operations. MetaMask Smart Accounts are signer-agnostic, allowing you
...
<CardList items={[
  {
    ...
    title: "MetaMask Embedded Wallets (recommended)",
