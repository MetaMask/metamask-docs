...
to use any signer you prefer i.e. Embedded Wallets, Passkeys, EOA wallets, or a custom signer.
...
third-party wallet providers as Privy, Dynamic, Para, etc as the signer for your smart account.
