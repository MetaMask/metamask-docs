...
If the user has not yet been upgraded, you can handle the upgrade [programmatically](/metamask-connect/evm/connect/guides/send-transactions/batch-transactions) or ask the 
