...
- A new ERC-7710 Wallet Client actions to create a redelegation and open redelegation from a delegation chain.
  See the [API reference](../reference/erc7710/wallet-client.md) to learn more.
- `createDelegation` now supports redelegation from encoded delegation chain (`permissionContext`).
  See the [API reference](../reference/delegation/index.md#createdelegation).
- `createOpenDelegation` now supports redelegation from encoded delegation chain (`permissionContext`).
