...
These metrics don't include any user information or transaction details.
If you wish to opt out, downgrade to a previous version.

:::

## Enhancements

- New utility `decodeCaveat` have been added to decode caveat's encoded `terms`. See [API reference](../reference/delegation/index.md#decodecaveat) to learn more.
