...
| `CaveatEnforcer:invalid-execution-type` | When redeeming a delegation, the execution uses a non default execution mode, but the caveat enforcer only supports the default mode.|
