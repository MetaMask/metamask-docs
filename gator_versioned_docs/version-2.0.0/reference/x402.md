...
The provider creates an <GlossaryTerm term="Open delegation">open delegation</GlossaryTerm>, signs it, and returns an ABI-encoded delegation
...
| `from`                    | [`MaybeDeferred`](./types.md#maybedeferred)<br/>`<Hex>`                                                                 | No       | The address that is granting the <GlossaryTerm term="Delegation">delegation</GlossaryTerm>. The default is `account`.                                                                                                                                                                                                                                                             |
| `salt`                    | [`MaybeDeferred`](./types.md#maybedeferred)<br/>`<Hex>`                                                                 | No       | The salt for generating the delegation hash. The default is a random 32-byte value.                                                                                                                                                                                                                                                                                               |
