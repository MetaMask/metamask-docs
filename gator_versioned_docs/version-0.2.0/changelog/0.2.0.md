---
sidebar_label: 0.2.0
description: MetaMask Smart Accounts Kit v0.2.0 changelog
---
...
- Smart Accounts Kit now supports the Sonic, Monad, Sei testnet, Sonic testnet and Hoodi. See [supported networks](../get-started/supported-networks.md) for more details.
- A new permission type, `erc20-token-revocation` has been added to Advanced Permissions.
