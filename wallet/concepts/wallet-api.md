...
[`wallet_requestSnaps`](/snaps/reference/snaps-api/wallet_requestsnaps.mdx).
...
- [`wallet_snap`](/snaps/reference/snaps-api/wallet_snap.mdx) - Gaining permission requires
  calling `wallet_requestSnap`.

- [`wallet_invokeSnap`](/snaps/reference/snaps-api/wallet_invokesnap.mdx) - Gaining
