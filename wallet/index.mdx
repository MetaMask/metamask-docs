...
Integrate your dapp with MetaMask using the [Wallet API](reference/json-rpc-api).
...
<CardList
  items={[
    ...
    {
      href: "how-to/manage-networks",
      title: "🌐 Manage networks",
      description:
        "Detect a user's network, and prompt them to add or switch networks.",
    },
    {
...
If you have questions about integrating your dapp with MetaMask using the Wallet API, you can ask on
the **mm-wallet-api** channel on [Consensys Discord](https://discord.gg/consensys).
