...
Integrate your dapp with the MetaMask wallet using the [Wallet API](concepts/wallet-api.md).
...
<CardList
  items={[
    ...
    },
    {
      ...
      description: "Learn about the MetaMask Wallet API and its components.",
    },
    {
      href: "concepts/sdk",
