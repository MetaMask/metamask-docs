...
- [Detect, add, and switch networks](/wallet/how-to/javascript/manage-networks).
- [Send transactions](../how-to/javascript/send-transactions.md).
- [Sign data](../how-to/javascript/sign-data/index.md).
- [Display tokens, contract methods, and icons in MetaMask](/wallet/how-to/javascript/display).
