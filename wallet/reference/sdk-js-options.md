...
Enables sending [read-only RPC requests](../how-to/js-infura-api.md) to
...
Configure this option to [make read-only RPC requests from your dapp](../how-to/js-infura-api.md).
...
A map of RPC URLs to use for [read-only RPC requests](../how-to/js-infura-api.md).
