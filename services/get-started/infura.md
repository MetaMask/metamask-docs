...
where you can view or configure your autogenerated API key. Infura automatically generates
the **My First Key** API key.
...
The Infura dashboard displays an overview of your daily request health and credit usage.
