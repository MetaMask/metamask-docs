...
#### 3.1. Update the Infura dashboard
...
- `<NETWORK-URL>` with the URL of an Infura network for which your key has access rights, and that supports the method [`eth_blockNumber`](../../reference/ethereum/json-rpc-methods/eth_blocknumber.mdx).
