...
Ignore the `"warning: unused import: types::TransactionRequest"` above. In the above transaction receipt, the transaction type shows `"type":"0x2"` indicating that this was an EIP-1559 transaction.
