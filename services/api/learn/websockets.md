...
subscription types are available using the [`eth_subscribe`](../networks/ethereum/json-rpc-methods/subscription-methods/eth_subscribe.mdx) JSON-RPC API:
...
For information about how to use the subscription methods to subscribe to events, see the [`eth_subscribe`](../networks/ethereum/json-rpc-methods/subscription-methods/eth_subscribe.mdx) JSON-RPC method, or see the following tutorials:
