...
Ensure you have an [API key](../../../dashboard/create-api.md) with the Polygon networked enabled.
...
1. Create your Javascript file and copy the following code:
    ...
    axios.post('https://polygon-mainnet.infura.io/v3/YOUR-API-KEY', {
      jsonrpc: '2.0',
      method: 'eth_blockNumber',
      params: [],
      id: 1
...
1. Create your Javascript file and copy the following code:
    ...
    const provider = new ethers.providers.JsonRpcProvider('https://polygon-mainnet.infura.io/v3/YOUR-API-KEY');
