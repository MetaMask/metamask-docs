...
import Returns from "/services/api/networks/_partials/_eth_gettransactionbyblockhashandindex-returns.mdx";
...
import Response from "/services/api/networks/_partials/_eth_gettransactionbyblockhashandindex-response.mdx";
