...
import Returns from "/services/api/networks/_partials/_eth_gettransactionbyhash-returns.mdx";
...
import Response from "/services/api/networks/_partials/_eth_gettransactionbyhash-response.mdx";
