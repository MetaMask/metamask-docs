---
title: Avalanche (C-Chain) eth_getProof
sidebar_label: eth_getProof
description: Returns account and storage proofs on Avalanche (C-Chain).
---
...
import Params from "/services/reference/_partials/_eth_getproof-parameters.mdx"
