...
Returns transaction signatures for a given asset, supporting only compressed assets created by the
[Metaplex Bubblegum program](https://developers.metaplex.com/bubblegum).
This is the easiest way to look up historical transactions for these assets.
