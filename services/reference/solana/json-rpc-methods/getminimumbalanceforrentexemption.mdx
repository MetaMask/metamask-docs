...
Returns the minimum balance (in lamports) required to make an account exempt from rent. <CreditCost network="solana" method="getMinimumBalanceForRentExemption" />
