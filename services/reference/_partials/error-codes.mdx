This section contains the JSON-RPC API endpoints on the left sidebar. You can [call these APIs using a variety of tools](../quickstart).
...
- [**JSON-RPC errors**](#json-rpc-errors):
  These are related to operations on the blockchain network. It means the server has received the JSON-RPC
...
The following tables lists the error codes, their messages, and meanings. The "Standard" category includes
...
| -33300 | Too Many Requests              | You have surpassed your [user-defined key throughput limit setting](/developer-tools/dashboard/how-to/secure-an-api/set-rate-limits). To make more requests, adjust your rate limit.                                                                      | Non-standard |
| -33400 | Too Many Requests              | You have surpassed your [user-defined key daily credit limit setting](/developer-tools/dashboard/how-to/secure-an-api/set-rate-limits). To make more requests, adjust your daily quota limit.                                                             | Non-standard |
...
| 402  | Payment Required      | You've reached your daily quota on your free plan. [Upgrade your plan](https://developer.metamask.io/billing/plan) to continue using the product for the day. |
