...
<Banner>
Don't have an Infura account? Sign up for our free plan and start using the ZKsync Era network!
</Banner>
...
1. Create your JavaScript file and copy the following code:
    ...
    fetch("https://zksync-mainnet.infura.io/v3/YOUR-API-KEY", {
      method: "POST",
      headers: {
...
Now that you have successfully made a call to the ZKsync Era network, you can explore more functionalities and APIs provided
