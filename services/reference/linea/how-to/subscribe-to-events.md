...
Use [WebSockets](../../../learn/websockets.md) to [subscribe](../../ethereum/json-rpc-methods/subscription-methods/index.md) to events
...
```bash
$ wscat -c wss//linea-goerli.infura.io/v3/<API-KEY>
