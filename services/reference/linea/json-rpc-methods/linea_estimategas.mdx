...
[gas fees topic](https://docs.linea.build/build-on-linea/gas-fees) in the Linea documentation.
...
- `TRANSACTION CALL OBJECT` _\[required]_
  ...
  - `block number`: _\[optional]_ A string representing a block number, or one of the string tags
