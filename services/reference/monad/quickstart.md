...
1. Create your JavaScript file and copy the following code:
   ...
   fetch("https://monad-mainnet.infura.io/v3/<YOUR-API-KEY>", {
     method: "POST",
     headers: {
...
1. Create your JavaScript file and copy the following code:
   ...
   axios
     .post("https://monad-mainnet.infura.io/v3/<YOUR-API-KEY>", {
       jsonrpc: "2.0",
       method: "eth_blockNumber",
       params: [],
       id: 1,
...
1. Create your JavaScript file and copy the following code:
   ...
   const provider = new ethers.providers.JsonRpcProvider(
     "https://monad-mainnet.infura.io/v3/<YOUR-API-KEY>"
   )
...
1. Create your Python file and copy the following code:
   ...
   url = "https://monad-mainnet.infura.io/v3/<YOUR-API-KEY>"
