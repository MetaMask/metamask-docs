---
description: Monad quickstart guide
sidebar_position: 2
...
This quickstart guide will help you set up and make calls on the Monad network using the Infura endpoints.

<Banner>
Don't have an Infura account? Sign up for our free plan and start using the Monad network!
</Banner>
...
1. Create your JavaScript file and copy the following code:
   ...
   fetch("https://monad-testnet.infura.io/v3/<YOUR-API-KEY>", {
     method: "POST",
     headers: {
...
1. Create your JavaScript file and copy the following code:
   ...
   axios
     .post("https://monad-testnet.infura.io/v3/<YOUR-API-KEY>", {
       jsonrpc: "2.0",
       method: "eth_blockNumber",
       params: [],
       id: 1,
...
1. Create your JavaScript file and copy the following code:
   ...
   const provider = new ethers.providers.JsonRpcProvider(
     "https://monad-testnet.infura.io/v3/<YOUR-API-KEY>"
   )
...
1. Create your Python file and copy the following code:
   ...
   url = "https://monad-testnet.infura.io/v3/<YOUR-API-KEY>"
...
Now that you have successfully made a call to the Monad network, you can explore more functionalities and APIs provided
by Infura. Here are some suggestions:

- **Explore other Monad APIs**: Infura supports a wide range of APIs. You can find more information in the
