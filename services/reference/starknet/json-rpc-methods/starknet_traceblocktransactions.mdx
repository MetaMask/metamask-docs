...
Returns the execution trace of all transactions in the specified block.
This provides the exact sequence of operations that were performed during the execution of each
...
A list of execution traces of all transactions in the requested block.
