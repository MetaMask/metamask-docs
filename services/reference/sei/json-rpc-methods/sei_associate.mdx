...
Sends a transaction to establish association between the signer's Sei address and EVM address onchain. This method enables cross-VM functionality by linking Cosmos SDK addresses with EVM addresses. <CreditCost network="evm" method="sei_associate" />

## Parameters

- `object`: [_Required_] A custom object containing a string message and the v, r, s of the signed message.
