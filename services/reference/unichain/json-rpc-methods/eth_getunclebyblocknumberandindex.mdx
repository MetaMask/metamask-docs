---
title: Unichain eth_getUncleByBlockNumberAndIndex
sidebar_label: eth_getUncleByBlockNumberAndIndex
description: Gets uncle by block number on Unichain.
---
...
import Params from "./_eth_unichain-getunclebyblocknumberandindex-parameters.mdx"
