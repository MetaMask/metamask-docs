---
title: Unichain eth_getTransactionCount
sidebar_label: eth_getTransactionCount
description: Gets transaction count for an address on Unichain.
---
...
import Params from "./_eth_unichain-gettransactioncount-parameters.mdx"
