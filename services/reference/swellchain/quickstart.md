---
description: Swellchain quickstart guide
sidebar_position: 2
...
# Swellchain quickstart

This quickstart guide will help you set up and make calls on Swellchain using the Infura endpoints.

<Banner>
Don't have an Infura account? Sign up for our free plan and start using the Swellchain network!
</Banner>

## Prerequisites

Ensure you have an [API key](/developer-tools/dashboard/get-started/create-api) with the Swellchain network enabled.
...
1. Create your JavaScript file and copy the following code:
   ...
   fetch("https://swellchain-mainnet.infura.io/v3/<YOUR-API-KEY>", {
     method: "POST",
     headers: {
...
1. Create your JavaScript file and copy the following code:
   ...
   axios
     .post("https://swellchain-mainnet.infura.io/v3/<YOUR-API-KEY>", {
       jsonrpc: "2.0",
       method: "eth_blockNumber",
       params: [],
       id: 1,
...
1. Create your JavaScript file and copy the following code:
   ...
   const provider = new ethers.providers.JsonRpcProvider(
     "https://swellchain-mainnet.infura.io/v3/<YOUR-API-KEY>"
   )
...
1. Create your Python file and copy the following code:
   ...
   url = "https://swellchain-mainnet.infura.io/v3/<YOUR-API-KEY>"
...
Now that you have successfully made a call to the Swellchain network, you can explore more functionalities and APIs provided
by Infura. Here are some suggestions:

- **Explore other Swellchain APIs**: Infura supports a wide range of APIs. You can find more information in the
