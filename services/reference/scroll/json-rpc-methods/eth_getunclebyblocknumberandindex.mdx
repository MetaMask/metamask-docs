---
title: Scroll eth_getUncleByBlockNumberAndIndex
sidebar_label: eth_getUncleByBlockNumberAndIndex
description: Gets uncle by block number on Scroll.
---
...
import Params from "./_eth_scroll-getunclebyblocknumberandindex-parameters.mdx"
