...
import Returns from "/services/api/network-apis/_partials/_eth_gettransactionbyblockhashandindex-returns.mdx";
...
import Response from "/services/api/network-apis/_partials/_eth_gettransactionbyblockhashandindex-response.mdx";
