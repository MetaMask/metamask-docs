...
import Returns from "/services/api/network-apis/_partials/_eth_gettransactionbyhash-returns.mdx";
...
import Response from "/services/api/network-apis/_partials/_eth_gettransactionbyhash-response.mdx";
