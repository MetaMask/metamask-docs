...
<Banner>
Don't have an Infura account? Sign up for our free plan and start using the Arbitrum network!
</Banner>

## Prerequisites

Ensure you have an [API key](../../../dashboard/create-api.md) with the Arbitrum network enabled.
...
1. Create your JavaScript file and copy the following code:
    ...
    axios.post('https://arbitrum-mainnet.infura.io/v3/YOUR-API-KEY', {
      jsonrpc: '2.0',
      method: 'eth_blockNumber',
      params: [],
      id: 1
...
Now that you have successfully made a call to the Arbitrum network, you can explore more functionalities and APIs provided
by Infura. Here are some suggestions:

- **Explore other Arbitrum APIs**: Infura supports a wide range of APIs. You can find more information in the
