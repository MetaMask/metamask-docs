...
The SDKs are referred to as MetaMask Embedded Wallet SDKs (formerly Web3Auth Plug and Play SDKs). Package names and APIs remain "Web3Auth" (for example, Web3Auth React SDK), and code snippets may reference `web3auth` identifiers.
