...
description: 'SMS OTP Login with Web3Auth | Embedded Wallets'
---
...
To use this feature, developers must first enable `SMS OTP` from the Social Connections section in the [Web3Auth Dashboard](https://dashboard.web3auth.io).
