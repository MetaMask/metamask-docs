...
description: 'Email Passwordless Login with Web3Auth | Embedded Wallets'
---
...
To use this feature, developers must first enable `Email Passwordless` from the Social Connections section in the [Web3Auth Dashboard](https://dashboard.web3auth.io).
