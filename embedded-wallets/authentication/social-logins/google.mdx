...
description: 'Google Login with Web3Auth | Embedded Wallets'
---
...
To use this feature, please enable `Google` from the Social Connections section in the [Web3Auth Dashboard](https://dashboard.web3auth.io).
