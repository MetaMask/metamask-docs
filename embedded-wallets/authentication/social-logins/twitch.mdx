...
description: 'Twitch Social Login with Web3Auth | Embedded Wallets'
---

import TwitchToggle from '@site/static/img/w3a-dashboard/authentication-social-connections.png'
import TwitchConnection from '@site/static/img/w3a-dashboard/twitch-connection.png'
...
2. Paste the following as a Redirect URI into the "OAuth Redirect URLs" field.
   ...
   ![Twitch OAuth2.0 App Dashboard](/img/authentication/twitch/twitch-app.png)

3. After creation of your Twitch app, click **Manage**

   ![Twitch OAuth2.0 App Manage](/img/authentication/twitch/twitch-manage.png)

4. Obtain the **Client ID**

   ![Twitch OAuth2.0 App Manage](/img/authentication/twitch/twitch-client-id.png)

## Create a Twitch Connection

:::success Enable on Dashboard

To use this feature, please enable `Twitch` from the Social Connections section in the [Web3Auth Dashboard](https://dashboard.web3auth.io).
