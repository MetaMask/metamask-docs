...
description: 'OAuth 2.0 Login with Web3Auth | Embedded Wallets'
---
...
To use this feature, please enable `X(Twitter)`, `Farcaster`, `Apple`, `GitHub`, `Reddit`, `Line`, `Kakao`, `LinkedIn` or `Wechat` from the Social Connections section in the [Web3Auth Dashboard](https://dashboard.web3auth.io).
