...
Use it for free on Sapphier Devnet; production use requires the [Scale Plan](https://web3auth.io/pricing.html).
...
For more context, see how [keys can change between products](/troubleshooting/different-private-key#product).
