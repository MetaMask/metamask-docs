...
| `launchWalletServices()` | v6       | Open the templated wallet UI (v10: `showWalletUI()`)     |
| `request()`              | v6.1     | Sign transactions with confirmation screens              |
| SMS Passwordless login   | v7.2     | `AuthConnection.SMS_PASSWORDLESS` with `loginHint`       |
| Farcaster login          | v7.2     | `AuthConnection.FARCASTER`                               |
