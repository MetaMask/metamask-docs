...
- Chain ID: 0x1
- Public RPC URL: <CopyableNoFollow url="https://fullnode.mainnet.aptoslabs.com/v1" />
- Display Name: Aptos Mainnet
- Block Explorer Link: [https://explorer.aptoslabs.com/](https://explorer.aptoslabs.com/)
- Ticker: APT
- Ticker Name: Aptos
...
- Chain Namespace: other
- Chain ID: 0x7E6
- Public RPC URL: <CopyableNoFollow url="https://fullnode.testnet.aptoslabs.com/v1" />
- Display Name: Aptos Testnet
- Block Explorer Link: [https://explorer.aptoslabs.com/testnet](https://explorer.aptoslabs.com/testnet)
- Ticker: APT
- Ticker Name: Aptos
