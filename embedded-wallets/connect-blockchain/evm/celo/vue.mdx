---
title: Integrate Embedded Wallets with the Celo Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/celo.png'

keywords: [celo, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Celo Blockchain in Vue | Embedded Wallets'
---
