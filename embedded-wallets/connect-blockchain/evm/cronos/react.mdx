---
title: Integrate Embedded Wallets with the Cronos Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/cronos.png'

keywords: [cronos, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Cronos Blockchain in React | Embedded Wallets'
---
