---
title: Integrate Embedded Wallets with the Cronos Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/cronos.png'

keywords: [react-native, cronos, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Cronos Blockchain in React Native | Embedded Wallets'
---
