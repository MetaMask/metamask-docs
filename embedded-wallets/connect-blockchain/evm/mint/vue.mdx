---
title: Integrate Embedded Wallets with the Mint Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/mint.png'

keywords: [mint, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Mint Blockchain in Vue | Embedded Wallets'
---
