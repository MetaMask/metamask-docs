---
title: Integrate Embedded Wallets with the Mint Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/mint.png'

keywords: [react-native, mint, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Mint Blockchain in React Native | Embedded Wallets'
---
