---
title: Integrate Web3Auth with the Linea Blockchain in Unity
sidebar_label: Unity
image: 'banners/unity.png'

keywords: [unity, linea, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Linea Blockchain in Unity | Documentation - Web3Auth'
---
...
- Chain ID: 0xe708
- Public RPC URL: https://rpc.linea.build (Avoid using public rpcTarget in production, use services like Infura)
...
- Chain ID: 0xe705
- Public RPC URL: https://rpc.sepolia.linea.build (Avoid using public rpcTarget in production, use services like Infura)
