---
title: Integrate Embedded Wallets with the Avalanche Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/avalanche.png'

keywords: [avalanche, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Avalanche Blockchain in React | Embedded Wallets'
---
