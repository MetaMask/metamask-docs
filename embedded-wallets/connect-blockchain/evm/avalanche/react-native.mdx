---
title: Integrate Embedded Wallets with the Avalanche Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/avalanche.png'

keywords: [react-native, avalanche, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Avalanche Blockchain in React Native | Embedded Wallets'
---
