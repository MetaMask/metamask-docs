---
title: Integrate Embedded Wallets with the Avalanche (C-Chain) Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/avalanche.png'

keywords: [react-native, avalanche, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Avalanche (C-Chain) Blockchain in React Native | Embedded Wallets'
---
...
<SEO
  ...
  slug="/embedded-wallets/connect-blockchain/evm/avalanche/react-native"
/>

While using the Embedded Wallets Mobile SDKs (formerly Web3Auth) in React Native, the private key is available in the SDK state. Use it with EVM libraries to derive accounts, sign, and make JSON-RPC calls to the [Avalanche (C-Chain)](https://www.avax.network/) network.
