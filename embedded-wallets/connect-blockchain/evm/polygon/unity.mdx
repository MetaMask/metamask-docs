---
title: Integrate Embedded Wallets with the Polygon Blockchain in Unity
sidebar_label: Unity
...
description: 'Integrate Embedded Wallets with the Polygon Blockchain in Unity | Embedded Wallets'
---
