---
title: Integrate Embedded Wallets with the Polygon Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/polygon.png'

keywords: [react-native, polygon, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Polygon Blockchain in React Native | Embedded Wallets'
---
