---
title: Integrate Embedded Wallets with the XDC Blockchain in JavaScript
sidebar_label: JavaScript
image: 'img/embedded-wallets/banners/xdc.png'

keywords: [xdc, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the XDC Blockchain in Javascript | Embedded Wallets'
---
