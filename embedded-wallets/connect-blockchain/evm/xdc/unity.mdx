---
title: Integrate Embedded Wallets with the XDC Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/xdc.png'

keywords: [unity, xdc, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the XDC Blockchain in Unity | Embedded Wallets'
---
