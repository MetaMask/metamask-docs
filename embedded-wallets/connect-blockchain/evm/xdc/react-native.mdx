---
title: Integrate Embedded Wallets with the XDC Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/xdc.png'

keywords: [react-native, xdc, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the XDC Blockchain in React Native | Embedded Wallets'
---
