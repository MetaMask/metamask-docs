---
title: Integrate Embedded Wallets with the Klaytn Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/klaytn.png'

keywords: [klaytn, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Klaytn Blockchain in React | Embedded Wallets'
---
