---
title: Integrate Web3Auth with the Klaytn Blockchain in JavaScript
sidebar_label: Web
image: 'banners/klaytn.png'

keywords: [klaytn, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Klaytn Blockchain in JavaScript | Documentation - Web3Auth'
---
