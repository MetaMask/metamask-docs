---
title: Integrate Embedded Wallets with the Arbitrum Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/arbitrum.png'

keywords: [arbitrum, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Arbitrum Blockchain in Vue | Embedded Wallets'
---
