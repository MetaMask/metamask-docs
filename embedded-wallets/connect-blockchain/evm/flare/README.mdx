...
description: 'Integrate Web3Auth with the Flare Blockchain | Embedded Wallets'
---
    ...
    tiles: [
      {
        ...
        title: 'Web',
        icon: 'logo-js.png',
        path: '/connect-blockchain/evm/flare/web',
      },
      {
        key: 'android',
        title: 'Android (Kotlin)',
        icon: 'logo-android.png',
        path: '/connect-blockchain/evm/flare/android',
      },
      {
        key: 'apple',
        title: 'iOS (Swift)',
        icon: 'logo-apple.png',
        path: '/connect-blockchain/evm/flare/ios',
      },
      {
        key: 'flutter',
        title: 'Flutter',
        icon: 'logo-flutter.png',
        path: '/connect-blockchain/evm/flare/flutter',
      },
      {
        key: 'react-native',
        title: 'React Native',
        icon: 'logo-react.png',
        path: '/connect-blockchain/evm/flare/react-native',
      },
      {
        key: 'unity',
        title: 'Unity',
        icon: 'logo-unity.png',
        path: '/connect-blockchain/evm/flare/unity',
      },
    ],
  },
]
