---
title: Integrate Web3Auth with the Optimism Blockchain in Unity
sidebar_label: Unity
image: 'banners/unity.png'

keywords: [unity, optimism, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Optimism Blockchain in Unity | Documentation - Web3Auth'
---
