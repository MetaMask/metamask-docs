---
title: Integrate Embedded Wallets with the Optimism Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/optimism.png'

keywords: [react-native, optimism, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Optimism Blockchain in React Native | Embedded Wallets'
---
