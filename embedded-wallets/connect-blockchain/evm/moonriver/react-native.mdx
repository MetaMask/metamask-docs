---
title: Integrate Embedded Wallets with the Moonriver Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/moonriver.png'

keywords: [react-native, moonriver, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Moonriver Blockchain in React Native | Embedded Wallets'
---
