---
title: Integrate Web3Auth with the Moonriver Blockchain in Unity
sidebar_label: Unity
image: 'banners/unity.png'

keywords: [unity, moonriver, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Moonriver Blockchain in Unity | Documentation - Web3Auth'
---
