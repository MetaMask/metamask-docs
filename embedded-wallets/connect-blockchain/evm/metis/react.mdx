---
title: Integrate Embedded Wallets with the Metis Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/metis.png'

keywords: [metis, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Metis Blockchain in React | Embedded Wallets'
---
