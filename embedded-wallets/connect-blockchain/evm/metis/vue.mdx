---
title: Integrate Embedded Wallets with the Metis Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/metis.png'

keywords: [metis, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Metis Blockchain in Vue | Embedded Wallets'
---
