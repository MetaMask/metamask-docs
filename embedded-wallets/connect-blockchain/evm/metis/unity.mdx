---
title: Integrate Embedded Wallets with the Metis Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/metis.png'

keywords: [unity, metis, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Metis Blockchain in Unity | Embedded Wallets'
---
