---
title: Integrate Embedded Wallets with the Metis Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/metis.png'

keywords: [react-native, metis, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Metis Blockchain in React Native | Embedded Wallets'
---
