---
title: Integrate Embedded Wallets with the Base Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/base.png'

keywords: [base, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Base Blockchain in Vue | Embedded Wallets'
---
