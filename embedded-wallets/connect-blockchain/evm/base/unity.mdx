---
title: Integrate Embedded Wallets with the Base Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/base.png'

keywords: [unity, base, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Base Blockchain in Unity | Embedded Wallets'
---
