---
title: Integrate Web3Auth with the Base Chain (Coinbase) Blockchain in React Native
sidebar_label: React Native
image: 'banners/base.png'

keywords: [react-native, base, coinbase, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Base Chain (Coinbase) Blockchain in React Native | Documentation - Web3Auth'
---
