---
title: Integrate Embedded Wallets with the Base Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/base.png'

keywords: [react-native, base, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Base Blockchain in React Native | Embedded Wallets'
---
