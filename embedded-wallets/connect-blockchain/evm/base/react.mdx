---
title: Integrate Embedded Wallets with the Base Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/base.png'

keywords: [base, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Base Blockchain in React | Embedded Wallets'
---
