---
title: Integrate Embedded Wallets with the Rootstock Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/rootstock.png'

keywords: [rootstock, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Rootstock Blockchain in React | Embedded Wallets'
---
