---
title: Integrate Embedded Wallets with the Rootstock Blockchain in Unity
sidebar_label: Unity
image: '/img/embedded-wallets/banners/rootstock.png'

keywords: [unity, rootstock, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Rootstock Blockchain in Unity | Embedded Wallets'
---
