---
title: Integrate Embedded Wallets with the Rootstock Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/rootstock.png'

keywords: [rootstock, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Rootstock Blockchain in Vue | Embedded Wallets'
---
