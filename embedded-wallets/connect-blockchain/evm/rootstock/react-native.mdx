---
title: Integrate Embedded Wallets with the Rootstock Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/rootstock.png'

keywords: [react-native, rootstock, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Rootstock Blockchain in React Native | Embedded Wallets'
---
