---
title: Integrate Web3Auth with the BNB Optimistic Rolllup in React Native
sidebar_label: React Native
image: 'banners/opbnb.png'

keywords: [react-native, opbnb, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the BNB Optimistic Rolllup in React Native | Documentation - Web3Auth'
---
