---
title: Integrate Embedded Wallets with the BNB Optimistic Rolllup in Flutter
sidebar_label: Flutter
image: '/img/embedded-wallets/banners/opbnb.png'

keywords: [flutter, opbnb, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the BNB Optimistic Rolllup in Flutter | Embedded Wallets'
---
