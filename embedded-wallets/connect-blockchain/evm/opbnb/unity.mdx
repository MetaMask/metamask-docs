---
title: Integrate Embedded Wallets with the BNB Optimistic Rolllup in Unity
sidebar_label: Unity
...
description: 'Integrate Embedded Wallets with the BNB Optimistic Rolllup in Unity | Embedded Wallets'
---
