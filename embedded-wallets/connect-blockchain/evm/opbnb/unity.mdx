---
title: Integrate Embedded Wallets with the OpBNB Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/opbnb.png'

keywords: [unity, opbnb, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the OpBNB Blockchain in Unity | Embedded Wallets'
---
