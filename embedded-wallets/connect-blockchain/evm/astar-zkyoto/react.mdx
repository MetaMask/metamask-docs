---
title: Integrate Embedded Wallets with the Astar Zkyoto Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/astar-zkyoto.png'

keywords: [astar-zkyoto, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Astar Zkyoto Blockchain in React | Embedded Wallets'
---
