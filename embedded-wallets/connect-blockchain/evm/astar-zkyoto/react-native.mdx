---
title: Integrate Embedded Wallets with the Astar Zkyoto Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/astar-zkyoto.png'

keywords: [react-native, astar-zkyoto, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Astar Zkyoto Blockchain in React Native | Embedded Wallets'
---
