...
description: 'Integrate Web3Auth with the Astar zKyoto Testnet | Documentation - Web3Auth'
---
    ...
    tiles: [
      {
        ...
        title: 'Web',
        icon: 'logo-js.png',
        path: '/connect-blockchain/evm/astar-zkyoto/web',
      },
      {
        key: 'android',
        title: 'Android (Kotlin)',
        icon: 'logo-android.png',
        path: '/connect-blockchain/evm/astar-zkyoto/android',
      },
      {
        key: 'apple',
        title: 'iOS (Swift)',
        icon: 'logo-apple.png',
        path: '/connect-blockchain/evm/astar-zkyoto/ios',
      },
      {
        key: 'flutter',
        title: 'Flutter',
        icon: 'logo-flutter.png',
        path: '/connect-blockchain/evm/astar-zkyoto/flutter',
      },
      {
        key: 'react-native',
        title: 'React Native',
        icon: 'logo-react.png',
        path: '/connect-blockchain/evm/astar-zkyoto/react-native',
      },
      {
        key: 'unity',
        title: 'Unity',
        icon: 'logo-unity.png',
        path: '/connect-blockchain/evm/astar-zkyoto/unity',
      },
    ],
  },
]
