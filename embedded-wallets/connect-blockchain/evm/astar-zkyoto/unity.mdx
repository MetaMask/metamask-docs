---
title: Integrate Embedded Wallets with the Astar zKyoto Testnet in Unity
sidebar_label: Unity
...
description: 'Integrate Embedded Wallets with the Astar zKyoto Testnet in Unity | Embedded Wallets'
---
