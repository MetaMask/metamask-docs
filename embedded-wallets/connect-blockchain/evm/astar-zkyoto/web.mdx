---
title: Integrate Embedded Wallets with the Astar zKyoto Testnet in JavaScript
sidebar_label: Web
image: '/img/embedded-wallets/banners/zkevm.png'

keywords: [zkyoto, astar, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Astar zKyoto Testnet in JavaScript | Embedded Wallets'
---
