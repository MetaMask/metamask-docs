---
title: Integrate Web3Auth with the Astar zkEVM Blockchain in React Native
sidebar_label: React Native
image: 'banners/zkevm.png'

keywords: [react-native, zkevm, astar, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Astar zkEVM Blockchain in React Native | Documentation - Web3Auth'
---
