---
title: Integrate Web3Auth with the Astar zkEVM Blockchain in Unity
sidebar_label: Unity
image: 'banners/unity.png'

keywords: [unity, zkevm, astar, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Astar zkEVM Blockchain in Unity | Documentation - Web3Auth'
---
