---
title: Integrate Embedded Wallets with the Bitkub Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/bitkub.png'

keywords: [bitkub, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Bitkub Blockchain in React | Embedded Wallets'
---
