---
title: Integrate Embedded Wallets with the Bitkub Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/bitkub.png'

keywords: [bitkub, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Bitkub Blockchain in Vue | Embedded Wallets'
---
