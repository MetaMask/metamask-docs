---
title: Integrate Embedded Wallets with the Unichain Blockchain in Unity
sidebar_label: Unity
...
description: 'Integrate Embedded Wallets with the Unichain Blockchain in Unity | Embedded Wallets'
---
...
<SEO
  ...
  slug="/embedded-wallets/connect-blockchain/evm/unichain/unity"
/>
...
- Chain ID: `0x82`
- Public RPC URL: `https://mainnet.unichain.org` (Avoid using public rpcTarget in production, use services like Infura)
...
- Chain ID: `0x515`
- Public RPC URL: `https://sepolia.unichain.org` (Avoid using public rpcTarget in production, use services like Infura)
