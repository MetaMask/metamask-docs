---
title: Integrate Embedded Wallets with the Unichain Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/unichain.png'

keywords: [unichain, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Unichain Blockchain in React | Embedded Wallets'
---
