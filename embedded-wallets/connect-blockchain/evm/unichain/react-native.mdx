---
title: Integrate Embedded Wallets with the Unichain Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/unichain.png'
keywords: [react-native, unichain, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Unichain Blockchain in React Native | Embedded Wallets'
---
