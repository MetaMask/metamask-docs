---
title: Integrate Embedded Wallets with the Unichain Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/unichain.png'

keywords: [unichain, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Unichain Blockchain in Vue | Embedded Wallets'
---
