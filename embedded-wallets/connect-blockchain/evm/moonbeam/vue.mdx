---
title: Integrate Embedded Wallets with the Moonbeam Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/moonbeam.png'

keywords: [moonbeam, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Moonbeam Blockchain in Vue | Embedded Wallets'
---
