---
title: Integrate Embedded Wallets with the Saakuru Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/saakuru.png'

keywords: [saakuru, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Saakuru Blockchain in React | Embedded Wallets'
---
