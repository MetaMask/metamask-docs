---
title: Integrate Embedded Wallets with the Saakuru Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/saakuru.png'

keywords: [react-native, saakuru, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Saakuru Blockchain in React Native | Embedded Wallets'
---
