---
title: Integrate Embedded Wallets with the Zircuit Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/zircuit.png'

keywords: [unity, zircuit, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Zircuit Blockchain in Unity | Embedded Wallets'
---
