---
title: Integrate Embedded Wallets with the Hedera Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/hedera.png'

keywords: [react-native, hedera, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Hedera Blockchain in React Native | Embedded Wallets'
---
