---
title: Integrate Embedded Wallets with the Hedera Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/hedera.png'

keywords: [hedera, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Hedera Blockchain in Vue | Embedded Wallets'
---
