---
title: Integrate Web3Auth with the Shardeum Blockchain in JavaScript
sidebar_label: Web
image: 'banners/shardeum.png'

keywords: [shardeum, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Shardeum Blockchain in JavaScript | Documentation - Web3Auth'
---
