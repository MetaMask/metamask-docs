---
title: Integrate Embedded Wallets with the Shardeum Blockchain in React Native
sidebar_label: React Native
image: '/img/embedded-wallets/banners/shardeum.png'

keywords: [react-native, shardeum, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Shardeum Blockchain in React Native | Embedded Wallets'
---
