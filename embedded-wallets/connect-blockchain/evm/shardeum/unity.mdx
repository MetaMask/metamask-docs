---
title: Integrate Web3Auth with the Shardeum Blockchain in Unity
sidebar_label: Unity
image: 'banners/shardeum.png'

keywords: [unity, shardeum, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the Shardeum Blockchain in Unity | Documentation - Web3Auth'
---
