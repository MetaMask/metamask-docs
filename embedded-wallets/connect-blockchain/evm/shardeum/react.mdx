---
title: Integrate Embedded Wallets with the Shardeum Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/shardeum.png'

keywords: [shardeum, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Shardeum Blockchain in React | Embedded Wallets'
---
