---
title: Integrate Embedded Wallets with the Shardeum Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/shardeum.png'

keywords: [shardeum, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Shardeum Blockchain in Vue | Embedded Wallets'
---
