---
title: Integrate Embedded Wallets with the Neon Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/neon.png'

keywords: [neon, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Neon Blockchain in Vue | Embedded Wallets'
---
