---
title: Integrate Embedded Wallets with the Nibiru Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/nibiru.png'

keywords: [react-native, nibiru, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Nibiru Blockchain in React Native | Embedded Wallets'
---
