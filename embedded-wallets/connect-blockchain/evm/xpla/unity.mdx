---
title: Integrate Embedded Wallets with the XPLA Blockchain in Unity
sidebar_label: Unity
...
description: 'Integrate Embedded Wallets with the XPLA Blockchain in Unity | Embedded Wallets'
---
