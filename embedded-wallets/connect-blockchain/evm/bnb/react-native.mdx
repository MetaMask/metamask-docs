---
title: Integrate Embedded Wallets with the BNB Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/bnb.png'

keywords: [react-native, bnb, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the BNB Blockchain in React Native | Embedded Wallets'
---
