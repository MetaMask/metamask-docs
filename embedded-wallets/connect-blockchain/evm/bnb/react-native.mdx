---
title: Integrate Embedded Wallets with the BNB (Binance) Blockchain in React Native
...
description: 'Integrate Embedded Wallets with the BNB (Binance) Blockchain in React Native | Embedded Wallets'
---
...
<SEO
  ...
  slug="/embedded-wallets/connect-blockchain/evm/bnb/react-native"
/>

While using the Embedded Wallets Mobile SDKs (formerly Web3Auth) in React Native, the private key is available in the SDK state. Use it with EVM libraries to derive accounts, sign, and make JSON-RPC calls to the [BNB (Binance) Chain](https://www.bnbchain.org/).
