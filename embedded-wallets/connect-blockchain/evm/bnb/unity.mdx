---
title: Integrate Embedded Wallets with the BNB Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/bnb.png'

keywords: [unity, bnb, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the BNB Blockchain in Unity | Embedded Wallets'
---
