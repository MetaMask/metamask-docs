---
title: Integrate Web3Auth with the BNB (Binance) Blockchain in Unity
sidebar_label: Unity
image: 'banners/unity.png'

keywords: [unity, binance, bnb, bsc, binanace smart chain, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the BNB (Binance) Blockchain in Unity | Documentation - Web3Auth'
---
