---
title: Integrate Embedded Wallets with the Manta Blockchain in Unity
sidebar_label: Unity
image: 'img/embedded-wallets/banners/manta.png'

keywords: [unity, manta, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Manta Blockchain in Unity | Embedded Wallets'
---
...
<SEO
  ...
  slug="/embedded-wallets/connect-blockchain/evm/manta/unity"
/>
...
- Chain ID: 0xA9
- Public RPC URL: https://pacific-rpc.manta.network/http (Avoid using public rpcTarget in production, use services like Infura)
...
- Chain ID: 0x34816E
- Public RPC URL: https://pacific-rpc.sepolia-testnet.manta.network/http (Avoid using public rpcTarget in production, use services like Infura)
