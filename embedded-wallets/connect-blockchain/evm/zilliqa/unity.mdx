---
title: Integrate Embedded Wallets with the Zilliqa Blockchain in Unity
sidebar_label: Unity
image: '/img/embedded-wallets/banners/zilliqa.png'

keywords: [unity, zilliqa, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Zilliqa Blockchain in Unity | Embedded Wallets'
---
