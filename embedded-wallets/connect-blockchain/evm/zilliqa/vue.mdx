---
title: Integrate Embedded Wallets with the Zilliqa Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/zilliqa.png'

keywords: [zilliqa, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Zilliqa Blockchain in Vue | Embedded Wallets'
---
