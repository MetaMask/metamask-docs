---
title: Integrate Embedded Wallets with the Ethereum Blockchain
...
description: 'Integrate Embedded Wallets with the Ethereum Blockchain | Embedded Wallets'
---
    ...
    tiles: [
      {
        ...
        title: 'Web',
        icon: 'logo-js.png',
        path: '/embedded-wallets/connect-blockchain/evm/ethereum/web',
      },
      {
        key: 'android',
