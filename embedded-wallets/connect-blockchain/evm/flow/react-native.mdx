---
title: Integrate Embedded Wallets with the Flow Blockchain in React Native
sidebar_label: React Native
image: 'img/embedded-wallets/banners/flow.png'
keywords: [react-native, flow, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Flow Blockchain in React Native | Embedded Wallets'
---
