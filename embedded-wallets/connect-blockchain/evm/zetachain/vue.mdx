---
title: Integrate Embedded Wallets with the Zetachain Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/zetachain.png'

keywords: [zetachain, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Zetachain Blockchain in Vue | Embedded Wallets'
---
