---
title: Integrate Web3Auth with the ZetaChain Blockchain in Unity
sidebar_label: Unity
image: 'banners/zetachain.png'

keywords: [unity, zetachain, web3auth, authentication, blockchain]
description: 'Integrate Web3Auth with the ZetaChain Blockchain in Unity | Documentation - Web3Auth'
---
