---
title: Integrate Embedded Wallets with the Chiliz Blockchain in Vue
sidebar_label: Vue
image: 'img/embedded-wallets/banners/chiliz.png'

keywords: [chiliz, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Chiliz Blockchain in Vue | Embedded Wallets'
---
