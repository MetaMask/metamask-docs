---
title: Integrate Embedded Wallets with the Chiliz Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/chiliz.png'

keywords: [chiliz, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Chiliz Blockchain in React | Embedded Wallets'
---
