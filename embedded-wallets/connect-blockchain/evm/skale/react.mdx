---
title: Integrate Embedded Wallets with the Skale Blockchain in React
sidebar_label: React
image: 'img/embedded-wallets/banners/skale.png'

keywords: [skale, web3auth, authentication, blockchain]
description: 'Integrate Embedded Wallets with the Skale Blockchain in React | Embedded Wallets'
---
