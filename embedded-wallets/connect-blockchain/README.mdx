...
description: 'Connect to any Blockchain via Web3Auth | Embedded Wallets'
...
## For Web3Auth Web SDK

The Web3Auth Web SDK(`@web3auth/modal`) from v10 onwards does not need any additional setup on the code side for blockchain connections. All of it is handled on the Dashboard. We can use any chain from the extensive list of predefined chains and add more if we need.
