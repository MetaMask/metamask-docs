...
While using the Embedded Wallets Web SDK, you get a Solana provider with functions to help you make blockchain calls via [`@solana/web3.js`](https://solana.com/docs/clients/javascript). Use this page for VanillaJS, Angular, and other frameworks.
...
To interact with the Solana blockchain, you can use [`@solana/web3.js`](https://solana.com/docs/clients/javascript) library with Web3Auth along with `@web3auth/solana-provider` package.
