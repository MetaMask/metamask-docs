...
While using the Embedded Wallets Web SDK, you get a Solana provider with functions to help you make blockchain calls via [`@solana/web3.js`](https://solana-labs.github.io/solana-web3.js/). Use this page for VanillaJS, Angular, and other frameworks.
