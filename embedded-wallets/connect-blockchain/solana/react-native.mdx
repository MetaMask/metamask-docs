...
While using the Web3Auth React Native SDK, you get a native Solana provider that can be used with [`@solana/web3.js`](https://solana.com/docs/clients/javascript). Use it to get accounts, balances, sign and send transactions, and sign messages.
...
To interact with the Solana blockchain in React Native, you can use [`@solana/web3.js`](https://solana.com/docs/clients/javascript) library with Web3Auth along with `@web3auth/solana-provider` package.
