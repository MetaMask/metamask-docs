...
While using the Web3Auth Vue SDK, you get access to native Solana composables. Pair them with [`@solana/web3.js`](https://solana.com/docs/clients/javascript) for advanced features such as transaction building, program interactions, and account queries.
...
For advanced Solana features, you should use [`@solana/web3.js`](https://solana.com/docs/clients/javascript) on top of the composables provided.
