...
import SolanaComposablesSnippets from '../../sdk/vue/_solana-composables-snippets.mdx'

While using the Embedded Wallets Vue SDK, you get access to native Solana composables. Pair them with [`@solana/kit`](https://www.npmjs.com/package/@solana/kit) for transaction building, program interactions, and account queries.
