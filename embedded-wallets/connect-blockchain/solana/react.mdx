...
While using the Web3Auth React SDK, you get access to native Solana hooks. Pair them with [`@solana/kit`](https://www.npmjs.com/package/@solana/kit) for transaction building, program interactions, and account queries.
