...
## Overview of cryptographic and blockchain support 

In terms of compatibility and implementations, Embedded Wallets supports the most popular blockchains and elliptic curves:
