---
title: Embedded Wallets' Shamir Secret Sharing Architecture
...
Alternatively, consider the [MPC architecture ](/embedded-wallets/infrastructure/mpc-architecture/) which does not fully-reconstruct the key.
