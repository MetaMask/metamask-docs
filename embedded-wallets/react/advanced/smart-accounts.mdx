...
![Enable Smart Accounts](/img/dashboard/smart-account/enable-smart-account.png)
...
![Configure Bundler & Paymaster](/img/dashboard/smart-account/configure-paymaster.png)
