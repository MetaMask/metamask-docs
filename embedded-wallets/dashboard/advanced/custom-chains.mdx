...
MetaMask Embedded Wallets (formerly Web3Auth) Web SDK v10 onwards does not need any additional setup on the code side for blockchain connections. This is handled on our updated Dashboard. You can use any chain from the extensive list of predefined chains and add more if needed by toggling them on.
...
4. Fill in the details of the chain you want to add such as LogoURL, Network Name.
5. Then press the **Save Network** blue button at the bottom.
