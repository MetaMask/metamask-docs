...
The wallet configuration tab within the Embedded Wallets dashboard enables developers to customize the wallet experience provided to users within their decentralized applications (dApps). These settings define the appearance, capabilities, and interactivity of the Embedded Wallets wallet interface.

<div style={{ flexBasis: '300px', flexGrow: '1', textAlign: 'center' }}>
  <img
    src={WalletConfiguration}
    style={{ alignSelf: 'center', maxWidth: '100%', width: '65%',  border: '3px solid #393d46', boxSizing: 'border-box' }}
