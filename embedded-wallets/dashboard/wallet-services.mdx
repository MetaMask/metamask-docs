...
description: 'Configure wallet services and UI in Web3Auth Dashboard | Documentation - Web3Auth'
---

import WalletConfiguration from '@site/static/img/w3a-dashboard/wallet-configuration.png'
