...
import AuthenticationSocialConnections from '@site/static/img/w3a-dashboard/authentication-social-connections.png'
import AuthenticationCustomConnections from '@site/static/img/w3a-dashboard/authentication-custom-connections.png'
