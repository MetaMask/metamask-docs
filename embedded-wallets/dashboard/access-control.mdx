...
| Allow by wallet address | Allowlist early tester EOAs                  |
...
Enable the social login consent screen from the dashboard alongside access control settings.
See [Consent screen](/embedded-wallets/features/consent-screen/) for Web SDK events and privacy guidance.
