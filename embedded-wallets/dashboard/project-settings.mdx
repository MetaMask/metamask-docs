...
The project settings section of the Embedded Wallets dashboard allows developers to manage core configuration options for each project. These settings determine how the project integrates with the Embedded Wallets SDK and how it behaves across different environments.
...
The client secret must never be exposed in frontend or client-side code, mobile applications, or any publicly accessible environment. Exposure could compromise your project's security.
...
Archiving preserves all project data and allows for restoration. If you need to permanently remove a project, contact Embedded Wallets support for assistance with proper data deletion procedures.
...
- [Allowlist settings](../allowlist) - Configure domain and URL authorization for enhanced security
...
3. Configure domain allowlisting for security
