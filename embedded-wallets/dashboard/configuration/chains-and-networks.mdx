...
description: 'Configure blockchain networks in Web3Auth Dashboard | Documentation - Web3Auth'
---

import ChainsAndNetworks from '@site/static/img/w3a-dashboard/chains-and-networks.png'
