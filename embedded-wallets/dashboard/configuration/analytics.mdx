...
description: 'Monitor project analytics in Web3Auth Dashboard | Documentation - Web3Auth'
---

import DashboardAnalytics from '@site/static/img/w3a-dashboard/dashboard-analytics.png'
