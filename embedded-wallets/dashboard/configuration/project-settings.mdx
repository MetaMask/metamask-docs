...
description: 'Configure project settings in Web3Auth Dashboard | Documentation - Web3Auth'
---

import ProjectSettingsGeneral from '@site/static/img/w3a-dashboard/project-settings-general.png'
import ProjectSettingsDomain from '@site/static/img/w3a-dashboard/project-settings-domain.png'
import ProjectSettingsAdvanced from '@site/static/img/w3a-dashboard/project-settings-advanced.png'
