...
![Dashboard Wallet Toggle](/img/embedded-wallets/dev-dashboard/external-wallets-toggle.png) _Toggle social logins and external wallets visibility._

![Dashboard Wallet Selector](/img/embedded-wallets/dev-dashboard/external-wallets-select-wallets.png) _Toggle and manage supported wallets._
