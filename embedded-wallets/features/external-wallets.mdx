...
keywords:
  [external wallets, connect and sign, SIWE, MetaMask Connect, wallet aggregator, web sdk, v11]
---
...
External wallet sign-in now defaults to **connect and sign**, a Sign-In with Ethereum (SIWE) style flow that authenticates the wallet in one step instead of requiring a separate connect followed by a signature prompt.
