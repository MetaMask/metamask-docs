...
<img
  className="docImg"
  src="/img/embedded-wallets/account-dashboard/unified-recovery-management.jpg"
  alt="Unified Recovery Management Screenshot"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/account-dashboard/account-dashboard-overview.jpg"
  alt="Account Dashboard Overview Screenshot"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/account-dashboard/device-overview.jpg"
  alt="Device Overview Screenshot"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/account-dashboard/security-insights.jpg"
  alt="Security Insights Screenshot"
/>
...
Add a "Manage account" or "Security" link to [account.web3auth.io](https://account.web3auth.io) in your app's settings/profile.
