...
description: 'Fiat On Ramp Aggregator | Embedded Wallets'
---

The Fiat On-Ramp Aggregator, a key component of the Wallet Services, streamlines the process of converting fiat to cryptocurrency. With integration requiring just a single line of code, it supports over 100 payment methods.

:::note

The Fiat on Ramp supports both Externally Owned Accounts (EOA) and Account Abstraction (AA) accounts powered by Web3Auth Native Account Abstraction.
...
For the complete list of fiat, crypto and payment method coverage, please check [here](https://docs.google.com/spreadsheets/d/1HwIDgFQ-J-ptImT9yp6MmLpZId3l1NGe9qWJJN88msY/edit#gid=0)

:::

### Network Coverage

The Onramp Aggregator is built to be chain-agnostic and supports a wide range of blockchain networks and tokens. Below is the list of main networks that we provide coverage.

![Coverage](/img/wallet-services/topup/topup-coverage.png)
...
![Providers](/img/wallet-services/topup/topup-providers.png)
