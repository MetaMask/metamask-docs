...
<img className="docImg" src="/img/nft-minting.svg" alt="NFT Minting" />
...
To initiate the minting process, provide the API with the necessary contract details, token ID, and recipient wallet address. The Embedded Wallets infrastructure handles mint execution. Web3Auth supports ERC-721 and ERC-1155 smart contracts across all EVM-compatible networks.
