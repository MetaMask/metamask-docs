...
- **Seamless onboarding:** Create wallets or [smart accounts](/smart-accounts-kit) as part of the invite or signup process, so users can jump into your app without additional steps.
