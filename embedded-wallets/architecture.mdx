...
For wallet management, the infrastructure uses cryptographic techniques such as
[Shamir's Secret Sharing](./infrastructure/sss-architecture.mdx), threshold cryptography, and
[Multi Party Computation (MPC)](./infrastructure/mpc-architecture.mdx). For more information, see
[Wallet management infrastructure](./infrastructure/README.mdx).
