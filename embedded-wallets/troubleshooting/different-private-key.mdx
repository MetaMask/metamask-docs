...
To learn more about creating custom connections, see [Authentication](/authentication).
...
Refer to the docs [here](/authentication/group-connections) to learn more about creating a group connection.
