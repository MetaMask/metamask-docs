...
:::info `@web3auth/modal` v11 and Vite

The [React quick start](https://github.com/Web3Auth/web3auth-examples/tree/main/quick-starts/react-quick-start)
runs on Vite **without** `buffer` or `process` polyfills. Build and test your app first; add the steps
below only if the bundler reports missing Node modules. See also the
[Web SDK v11 migration guide](/embedded-wallets/migration-guides/web#v11-api-changes).
