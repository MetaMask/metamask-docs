...
description: 'Pluggable embedded wallet infrastructure that simplifies web3 wallet integration and user onboarding. OAuth-based logins and multiple platforms.'
---
...
Give your users web3 wallets with social sign-in methods they already use.

### Step 1: Create a developer account

Sign up at the Embedded Wallets dashboard: [developer.metamask.io](https://developer.metamask.io/). The basic plan
is free.
