...
description: '@web3auth/modal Wallet UI | Embedded Wallets'
---
...
All these configurations can be directly accessed and managed through the [Embedded Wallets dashboard](https://dashboard.web3auth.io). Manual configuration in the SDK is optional and provided here for reference purposes.
