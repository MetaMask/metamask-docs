...
![Enable Smart accounts](/img/embedded-wallets/dev-dashboard/smart-account/enable-smart-account.png)
...
![Configure bundler and paymaster](/img/embedded-wallets/dev-dashboard/smart-account/configure-paymaster.png)
