...
This guide focuses specifically on migrating React applications from Web3Auth v9 to v10. This is a supplementary guide to the main [v9 to v10 migration guide](../../js/migration-guides/modal-v9-to-v10.mdx).
...
Refer to the [React Modal SDK Hooks documentation](/docs/sdk/react/hooks) for the detailed SDK reference.
...
Return to the main [v9 to v10 migration guide](./modal-v9-to-v10.mdx) to continue with other migration aspects like MFA configurations, method renames, and chain configuration changes.
