...
- **[Whitelabeling & UI Customization](/embedded-wallets/sdk/react/advanced/whitelabel)**: Personalize the modal's appearance.
...
Head over to the [**Advanced Configuration**](/embedded-wallets/sdk/react/advanced) section to learn more about each configuration option.
...
For detailed usage and examples, visit the [**Solana Hooks**](/embedded-wallets/sdk/react/solana-hooks) section.
