...
In V5, android compile target sdk is changed from 33 to 34. If you previously used the target SDK
with 33, update your build.gradle file.
...
In v5, the way parameters are configured has changed. The buildEnv parameter must be included. The
whiteLabel parameter type and configuration has changed. And, as mentioned earlier, the network type
has been added.
