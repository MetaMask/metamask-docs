---
title: Android SDK - v7.2 to v7.3

description: 'Android SDK - v7.2 to v7.3 | Embedded Wallets'
...
# Migration Guide from v7.2 to v7.3 for Web3Auth Android SDK

## Overview

This migration guide provides steps for upgrading from version 7.2(v7.2) to version 7.3(v7.3) of the Web3Auth Android SDK. The guide outlines significant changes in the `request` method.
