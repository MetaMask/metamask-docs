...
Once the gradles and permission has been updated, you need to configure Web3Auth project by allowlisting your scheme and package name.
...
- Allowlist `{SCHEME}://{YOUR_APP_PACKAGE_NAME}` in the developer dashboard. This step is mandatory for the redirect to work.
