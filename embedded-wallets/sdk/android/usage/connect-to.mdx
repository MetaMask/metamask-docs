...
It triggers the login flow and opens a browser modal where the user can authenticate.
Pass supported auth connections to `connectTo` for specific social logins such as GOOGLE, APPLE, and FACEBOOK, or use whitelabel login.
