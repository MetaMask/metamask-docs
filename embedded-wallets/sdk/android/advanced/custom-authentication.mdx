...
To use custom authentication (using Social providers or Login providers like Auth0, AWS Cognito, Firebase, and others, or even your own custom JWT login) you can add the configuration using `loginConfig` parameter during the initialization.
