...
| `dappShare?`         | Custom logins can get a dapp share returned to them post successful login. This is useful if the dapps want to use this share to allow users to sign in without repeating the full flow. `dappShare` is a 24 word seed phrase. It accepts `string` as a value.                                                                                                                                                                                                                                                                                                                                                                 |
...
| `redirectUrl?`       | App's URL where user will be redirected after login. Register this URL in the [developer dashboard](https://developer.metamask.io), else initialization will give error. It accepts `string` as a value.                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
export type LoginParams = BaseRedirectParams & {
   ...
   * This is useful if the dapps want to use this share to allow users to sign in without repeating the full flow
