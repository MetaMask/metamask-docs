...
These Node.js dependencies need to be polyfilled in your application. We've prepared detailed
troubleshooting guides for popular bundlers:
...
If you're getting different private keys across integrations, see our guide on
[**Different Private Keys across integrations**](/troubleshooting/different-private-key).
