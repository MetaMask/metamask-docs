...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `clientId`             | The unique identifier for your application. Obtain this by registering your dapp in the [Embedded Wallets dashboard](https://developer.metamask.io)                                                                                                                                                                                                      |
...
| `originData`           | originData is used to verify the origin of dapp by iframe. You don't have to pass originData explicitly if you have registered your dapp at [developer dashboard](https://developer.metamask.io). originData contains a signature of dapp's origin URL which is generated using project's secret.                                                        |
| `loginConfig`          | loginConfig enables you to pass your own login verifiers configuration for various loginProviders. loginConfig is key value map where each key should be a valid loginProvider and value should be custom configuration for that loginProvider. You can deploy your own verifiers from [developer dashboard](https://developer.metamask.io) to use here. |
...
export type AuthOptions = {
     ...
     * dapp on {@link "https://developer.metamask.io"| developer dashboard}
     */
    clientId: string;
    /**
     ...
     *
     * @remarks
     * Register this URL at {@link "https://developer.metamask.io"| developer dashboard}
     ...
     * {@link "https://developer.metamask.io"| developer dashboard}.
     *
     ...
     *
     * @remarks
     * You can deploy your own verifiers from {@link "https://developer.metamask.io"| developer dashboard}
     * to use here.
     *
     */
