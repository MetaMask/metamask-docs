import Image4 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-dark.png'
import Image7 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-language.png'
import Image3 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-light.png'
import Image9 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-logo-dark.png'
import Image8 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-logo-light.png'
import DashboardImage from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-theme1.png'
import Image6 from '@site/static/img/tutorials/whitelabel-web3auth-openlogin-theme2.png'
