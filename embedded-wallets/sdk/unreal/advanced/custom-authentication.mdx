...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/provider-options.png"
  alt="Unreal Blueprint Login Options"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/google-custom-auth.png"
  alt="Unreal Blueprint Google Custom Login"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/fb-custom-auth.png"
  alt="Unreal Blueprint Facebook Custom Login"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/email-passwordless.png"
  alt="Unreal Blueprint Email Passwordless Custom Login"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/auth0-login-config.png"
  alt="Unreal Blueprint Auth0 Custom Login"
/>
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/extraloginoption-auth0.png"
  alt="Unreal Blueprint Auth0 Extralogin option"
/>
