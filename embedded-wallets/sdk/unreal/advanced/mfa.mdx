...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/mfa.png"
  alt="Unreal Blueprint MFA Options"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/unreal/unreal-mfa-settings.png"
  alt="Unreal Blueprint MFA Settings Options"
/>
