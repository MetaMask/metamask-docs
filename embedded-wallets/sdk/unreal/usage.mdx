...
sidebar_label: Usage
description: 'Web3Auth PnP Unreal Engine SDK - Usage | Embedded Wallets'
---
...
This function helps your user to trigger the login process. The login flow will be triggered based on the selected provider. You can view the list of selected providers in the [provider](#provider) section.
