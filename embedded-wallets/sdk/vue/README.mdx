...
- **[Whitelabeling & UI Customization](/embedded-wallets/sdk/vue/advanced/whitelabel)**: Personalize the modal's appearance.
...
Head over to the [**Advanced Configuration**](/embedded-wallets/sdk/vue/advanced) section to learn more about each configuration option.
...
For detailed usage and examples, visit the [**Solana Composables**](/embedded-wallets/sdk/vue/solana-composables) section.
