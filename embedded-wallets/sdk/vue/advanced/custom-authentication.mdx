...
To enable this, you need to [create a connection](../../../dashboard/authentication.mdx) from the **Authentication** tab of your project from the [Embedded Wallets developer dashboard](https://developer.metamask.io) with your desired configuration.
...
Learn more about the [auth provider setup](../../../authentication/README.mdx) and the different configurations available for each connection.
...
Learn more about the `modalConfig` object in the [Whitelabel](./whitelabel.mdx) section.
