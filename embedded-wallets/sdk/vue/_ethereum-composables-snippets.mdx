You need to install the `@wagmi/vue` and `@tanstack/vue-query` packages and use the **Web3Auth
...
Web3Auth integrates with Wagmi, so you can use composables like `useConnection`,
