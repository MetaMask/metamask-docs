...
This guide focuses specifically on migrating Vue applications from Web3Auth v9 to v10. This is a supplementary guide to the main [v9 to v10 migration guide](../../js/migration-guides/modal-v9-to-v10.mdx).
...
Please refer to the [Vue Modal SDK documentation](/docs/sdk/vue/) for the SDK reference.
