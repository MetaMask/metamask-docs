...
| `verifierSubIdentifier?` | The field in JWT token which maps to verifier ID. Ensure you selected correct JWT verifier ID in the developer dashboard. It accepts `String` as a value.                                                                                                                                                               |
