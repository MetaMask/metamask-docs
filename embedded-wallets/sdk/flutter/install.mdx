---
title: 'Installing Embedded Wallet Flutter SDK'
sidebar_label: 'Install'
description: 'Installing MetaMask Embedded Wallet Flutter SDK (formerly Web3Auth PnP)'
---

import IOSWhitelist from '../_common/_ios-whitelist.mdx'

> MetaMask Embedded Wallet SDKs were previously marketed as Web3Auth Plug and Play SDKs. Package names and APIs remain Web3Auth (for example, `web3auth_flutter`).
