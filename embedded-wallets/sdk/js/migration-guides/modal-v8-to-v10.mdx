---
title: Migrating to the Web3Auth PnP Web SDK v10 from v8
description:
  Learn what has changed from Web3Auth v8 to the v10 Web SDK with comprehensive migration steps and
...
This guide will help you upgrade your Web3Auth PnP SDK integration from v8 directly to the **unified
...
In v8, authentication used `OpenloginAdapter`. V9 renamed it to `AuthAdapter`. V10 eliminates the
need for separate adapters in most cases.
...
**External Wallet Adapters:** If you used external wallet adapters (MetaMask, Phantom, Solflare,
etc.) in v8, see the 🔌
**[External Wallet Adapters Migration Guide](./modal-v8-to-v10-external-wallets.mdx)** for migrating
to the automatic detection system.
...
With v10, configurations that were previously done in code are now managed through the Web3Auth
Developer Dashboard:
