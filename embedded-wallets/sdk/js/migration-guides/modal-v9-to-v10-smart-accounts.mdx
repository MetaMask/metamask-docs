...
This guide focuses specifically on migrating Smart Account configurations from Web3Auth v9 to v10. This is a supplementary guide to the main [v9 to v10 migration guide](./modal-v9-to-v10.mdx).
...
See [Web3Auth React Smart Accounts](/docs/sdk/react/advanced/smart-accounts) to learn more.
