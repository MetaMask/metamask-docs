...
- Most general branding settings previously in the client-side `uiConfig` (e.g., `appName`, `logoLight`, `logoDark`, `theme` colors) are **now primarily configured on the [Embedded Wallets dashboard](https://dashboard.web3auth.io)**. ![Branding customizations on Web3Auth / Embedded Wallets Dashboard](/img/embedded-wallets/whitelabel/modal/branding.gif)
