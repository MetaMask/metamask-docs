---
title: Migrating Wallet Services from v9 to v10
description: Comprehensive guide for migrating Web3Auth Wallet Services plugin from v9 to v10.
...
This guide focuses specifically on migrating Wallet Services functionality from Web3Auth v9 to v10.
This is a supplementary guide to the main [v9 to v10 migration guide](README.mdx).

## Overview

In v9, Wallet Services (checkout, swap, WalletConnect scanner, Embedded Wallet UI) required
