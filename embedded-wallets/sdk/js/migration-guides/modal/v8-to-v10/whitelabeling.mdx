...
Return to the main [v8 to v10 migration guide](./modal-v8-to-v10.mdx) to continue with other migration aspects like Smart Account functionality, custom authentication, and MFA configurations.
