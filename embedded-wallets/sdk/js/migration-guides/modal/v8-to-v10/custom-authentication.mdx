...
Web3Auth Developer Dashboard (now the [Embedded Wallets dashboard](https://dashboard.web3auth.io/)). Locate your migrated connection, note its `authConnectionId`, and use
