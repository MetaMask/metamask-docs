...
- **Dashboard-Centric Configuration:** Chain configurations managed via Web3Auth Developer Dashboard (now the [Embedded Wallets dashboard](https://dashboard.web3auth.io/))
...
Configure your chains on the [Embedded Wallets dashboard](https://dashboard.web3auth.io/) instead of in code.
