...
**External Wallet Adapters:** If you used external wallet adapters (MetaMask, Phantom, Solflare, etc.) in v8, see the 🔌 **[External Wallet Adapters Migration Guide](/embedded-wallets/sdk/js/migration-guides/modal/v8-to-v10/external-wallets)** for migrating to the automatic detection system.
