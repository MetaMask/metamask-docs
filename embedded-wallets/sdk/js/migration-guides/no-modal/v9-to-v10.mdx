---
title: Migrating to the Web3Auth PnP Web SDK v10 from v9 (No-Modal)
description:
  Learn how to migrate from Web3Auth No-Modal v9 to the unified v10 SDK with connectTo functionality
...
This guide will help you upgrade your Web3Auth No-Modal SDK integration from v9 to the **unified
...
4. Configure your chains and branding on the Embedded Wallets dashboard
