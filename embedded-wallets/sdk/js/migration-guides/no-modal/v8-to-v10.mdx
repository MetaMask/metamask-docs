...
- **Dashboard-Centric Configuration:** Chain configurations managed via the Web3Auth Developer Dashboard (now the [Embedded Wallets dashboard](https://dashboard.web3auth.io/))
...
const web3auth = new Web3Auth({
  clientId: 'YOUR_CLIENT_ID',
  web3AuthNetwork: WEB3AUTH_NETWORK.SAPPHIRE_MAINNET,
  // Chain configuration managed via Embedded Wallets/Web3Auth Developer Dashboard
})
// add-end
```
...
Configure your chains on the [Embedded Wallets dashboard](https://dashboard.web3auth.io/) instead
of in code.
