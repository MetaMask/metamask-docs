...
import Eip7702SmartAccounts from '../../_common/_eip-7702-smart-accounts.mdx'

Create and manage smart accounts for your users with just a few lines of code, using our Smart Account feature. Smart accounts offer enhanced control and programmability, enabling features that traditional wallets can't provide.
...
To enable smart accounts, navigate to the smart accounts section in the [Embedded Wallets dashboard](https://developer.metamask.io/), and enable the **Set up Smart accounts** toggle. Embedded Wallets currently supports [MetaMaskSmartAccount](https://docs.gator.metamask.io/how-to/create-delegator-account#create-a-metamasksmartaccount) as a Smart Account provider.

<img
  className="docImg"
  src="/img/embedded-wallets/dev-dashboard/smart-account/enable-smart-account.png"
  alt="Enable Smart accounts"
/>
...
<img
  className="docImg"
  src="/img/embedded-wallets/dev-dashboard/smart-account/configure-paymaster.png"
  alt="Configure bundler and paymaster"
/>
