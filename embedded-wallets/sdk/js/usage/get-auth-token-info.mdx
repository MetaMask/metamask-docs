---
title: getAuthTokenInfo
sidebar_label: Get auth token info
description: '@web3auth/modal getAuthTokenInfo | Embedded Wallets'
---
...
type AuthTokenInfo = { idToken: string };
```
...
```tsx
export type AuthTokenInfo = { idToken: string }
```
