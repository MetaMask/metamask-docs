...
If your dapp uses default dashboard connections, users can directly log in to the account dashboard to manage MFA. For custom connection-based dapps, the `manageMFA()` method must be used.
