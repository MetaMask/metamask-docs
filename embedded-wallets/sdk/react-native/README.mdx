...
Use the single [Migrate to v9](./migrate-to-v9.mdx) guide. It includes an LLM agent prompt, a full legacy-to-v9 API map, and step-by-step file targets for any prior `@web3auth/react-native-sdk` version.
