...
description: '@web3auth/react-native-sdk Native Account Abstraction | Embedded Wallets'
---
...
import AAModalSetup from '../../_common/_aa-modal-setup.mdx'
import ConfigurePaymasterContext from '../../_common/_configure-paymaster-context.mdx'
