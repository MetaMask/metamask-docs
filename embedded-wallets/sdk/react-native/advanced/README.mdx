...
const web3auth = new Web3Auth(WebBrowser, SecureStore, {
  clientId: 'YOUR_WEB3AUTH_CLIENT_ID', // Pass your Embedded Wallets Client ID, ideally using an environment variable // Get your Client ID from Embedded Wallets dashboard
