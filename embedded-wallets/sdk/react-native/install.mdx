---
title: 'Installing Embedded Wallet React Native SDK'
sidebar_label: 'Install'
description: 'Installing MetaMask Embedded Wallet React Native SDK (formerly Web3Auth Plug and Play)'
---

import TabItem from '@theme/TabItem'
import Tabs from '@theme/Tabs'

> MetaMask Embedded Wallet SDKs were previously marketed as Web3Auth Plug and Play SDKs. Package names and APIs remain Web3Auth (for example, `@web3auth/react-native-sdk`).
...
Your Bare React Native app is entirely built on your machine. In this workflow, the developer has complete control, along with the complexity that comes with that. Configuration with `app.json` / `app.config.js` is mostly not supported in this context; instead, you will need to configure each native project directly with Swift/Kotlin native modules. Check out the [troubleshooting section](/embedded-wallets/sdk/react-native/install#troubleshooting) for fixing common issues.
...
- [EIP1193 Private Key Provider for EVM Compatible Chains](/embedded-wallets/sdk/react-native/providers/evm)
- [Solana Private Key Provider for Solana Blockchain](/embedded-wallets/sdk/react-native/providers/solana)
- [XRPL Private Key Provider for XRPL Blockchain](/embedded-wallets/sdk/react-native/providers/xrpl)
- [Common Private Key Provider for Connecting to any Blockchain](/embedded-wallets/sdk/react-native/providers/common)
