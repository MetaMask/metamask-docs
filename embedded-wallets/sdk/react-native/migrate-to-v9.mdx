---
title: Migrate React Native SDK to v9
sidebar_label: Migrate to v9
description: 'Single migration guide from any legacy @web3auth/react-native-sdk version to v9 hooks API | Embedded Wallets'
---
...
- [Example apps](https://github.com/Web3Auth/web3auth-react-native-examples)
