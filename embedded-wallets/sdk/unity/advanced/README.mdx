...
Create a seamless brand experience by customizing the Web3Auth Login Screens to match your Unity application's design. For complete customization options, refer to the [Whitelabeling & UI Customization](/embedded-wallets/sdk/unity/advanced/whitelabel) section.
