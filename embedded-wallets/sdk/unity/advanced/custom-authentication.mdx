...
| `clientId`               | Client ID provided by your login provider, such as Google's Client ID or Web3Auth's client ID if using `jwt` as `TypeOfLogin`. It's a mandatory field, and accepts `string` as a value.                                                                                                                             |
