...
MetaMask Embedded Wallets SDK (formerly Web3Auth Plug and Play) provides a seamless authentication experience for Unity game applications with social logins, external wallets, and more. Our Unity SDK, written in C#, simplifies how you connect users to their preferred wallets and manage authentication state across all mobile platforms.
...
- From the [Embedded Wallets dashboard](https://dashboard.web3auth.io/), create or select an Web3Auth project:
...
We recommend you use the [Nethereum Library](https://docs.nethereum.com/en/latest/unity3d-introduction/) for making the blockchain calls. See [how to integrate Nethereum with Web3Auth](../../connect-blockchain/evm/ethereum/unity.mdx).
