...
In v7, you can configure additional `coreKitKey` and `coreKitEd25519PrivKey` fields when you
...
fields of the `W3AInitParams` object. With v7, additional 2 parameters, which are `MfaSettings` and
`sessionTime` can be set.
