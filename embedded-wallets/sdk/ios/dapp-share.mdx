---
title: Using dApp Share in PnP iOS SDK
sidebar_label: dApp Share
description: "Web3Auth PnP iOS SDK - dApp Share | Documentation - Web3Auth"
---
...
non custodiality of Web3Auth, we split the private key into multiple parts, i.e. `shares`. These
