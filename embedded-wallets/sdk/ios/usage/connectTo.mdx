...
<Tabs
  ...
  values={[
    ...
    { label: "Email Passwordless", value: "EmailPasswordless" },
    { label: "SMS Passwordless", value: "SmsPasswordless" },
    { label: "Farcaster", value: "Farcaster" },
    { label: "SFA JWT", value: "SfaJwt" },
  ]}
>
...
<TabItem value="EmailPasswordless">
