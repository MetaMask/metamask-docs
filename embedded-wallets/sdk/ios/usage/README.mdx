...
| -------------------------------- | --------------------------------------------------- |
| [`connectTo()`](./connectTo.mdx) | Logs in the user with the selected auth connection. |
...
| Function Name                                          | Description                                                                     |
| ------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [`getPrivateKey()`](./getPrivateKey.mdx)               | Retrieve the user's secp256k1 private key for EVM-compatible chains.            |
| [`getEd25519PrivateKey()`](./getEd25519PrivateKey.mdx) | Retrieve the user's ed25519 private key for chains like Solana, Near, Algorand. |
