...
For defining custom UI, branding, and translations for your brand app, you just need to define an optional object called `WhiteLabelData`. `WhiteLabelData` can be defined during initialization of the SDK in `Web3AuthOptions`.
...
| `theme?`           | Used to customize the theme of the login modal. It accepts a dictionary of `[String: String]` as a value.                                                                |
